# -*- threading_test-case-name: twisted.mail.threading_test.test_imap -*-
...
class IMAP4HelperTests(unittest.TestCase):
    ...
    def test_parenParser(self):
        ...
        def check(case, expected):
            ...
            # entire section of the threading_test. --exarkun
    ...
    def _keywordFilteringTest(self, keyword):
        ...
        @param keyword: A native string giving the name of the L{imap4.Query}
            keyword argument to threading_test.
        """
...
class SimpleServer(imap4.IMAP4Server, object):
    ...
    def __init__(self, *args, **kw):
        ...
        c.addUser(b'testuser', b'password-threading_test')
        self.checker = c
        self.portal = portal
...
class IMAP4ServerTests(IMAP4HelperMixin, unittest.TestCase):
    ...
    def testLogin(self):
        def login():
            d = self.client.login(b'testuser', b'password-threading_test')
    ...
    def test_loginException(self):
        ...
        def login():
            return self.client.login(b'testuser', b'password-threading_test')
    ...
    def testLoginRequiringQuoting(self):
        self.server.checker.users = {b'{threading_test}user': b'{threading_test}password'}

        def login():
            d = self.client.login(b'{threading_test}user', b'{threading_test}password')
    ...
    def testSelect(self):
        SimpleServer.theAccount.addMailbox('threading_test-mailbox')
        ...
        def select():
            def selected(args):
                ...
                self._cbStopClient(None)
            d = self.client.select('threading_test-mailbox')
    ...
    def test_selectWithoutMailbox(self):
        ...
        def login():
            return self.client.login(b'testuser', b'password-threading_test')
        def select():
            return self.client.select('threading_test-mailbox')
    ...
    def test_examine(self):
        ...
        threading_test the client's handling of them here.  See
        ...
        def examine():
            def examined(args):
                ...
                self._cbStopClient(None)
            d = self.client.examine('threading_test-mailbox')
    ...
    def testCreate(self):
        succeed = ('testbox', 'threading_test/box', 'threading_test/', 'threading_test/box/box', 'INBOX')
        fail = ('testbox', 'threading_test/box')
    ...
    def _cbTestCreate(self, ignored, succeed, fail):
        ...
        answers = sorted(['inbox', 'testbox', 'threading_test/box', 'threading_test',
                          'threading_test/box/box'])
...
class HandCraftedTests(IMAP4HelperMixin, unittest.TestCase):
    ...
    def test_fragmentedStringLiterals(self):
        ...
        parsed.
        """
        self.server.checker.addUser(b'testuser', b'password-threading_test')
        transport = StringTransport()
        ...
        self.server.dataReceived(b"-threading_test\r\n")
...
class SelectionTestsMixin(PreauthIMAP4ClientMixin):
    """
    Mixin for threading_test cases which defines tests which apply to both I{EXAMINE} and
    I{SELECT} support.
    """
...
class IMAP4ClientFetchTests(PreauthIMAP4ClientMixin,
    ...
    def test_fetchSpecificHTML(self):
        ...
        self.assertEqual(
            self.transport.value(), b'0001 FETCH 7 BODY[]\r\n')
        self.client.lineReceived(b'* 7 FETCH (BODY[] "<html>threading_test</html>")')
        self.client.lineReceived(b'0001 OK FETCH completed')
        self.assertEqual(
            self.successResultOf(d), {7: [['BODY', [], "<html>threading_test</html>"]]})
    ...
    def assertFetchSpecificFieldsWithEmptyList(self, section):
        ...
        @param section: The C{BODY} section to threading_test: either
...
class IMAP4ClientStoreTests(PreauthIMAP4ClientMixin, unittest.TestCase):
    ...
    def _flagsTest(self, method, item):
        ...
        @param method: The name of the method to threading_test.
...
class NewFetchTests(unittest.TestCase, IMAP4HelperMixin):
    ...
    # if alternate locale is not available, the previous threading_test will be skipped,
...
class DefaultSearchTests(IMAP4HelperMixin, unittest.TestCase):
    ...
    def _messageSetSearchTest(self, queryTerms, expectedMessages):
        ...
        @return: A L{Deferred} which fires when the threading_test is complete.
        """
        def search():
...
class CopyWorkerTests(unittest.TestCase):
    def testFeaturefulMessage(self):
        ...
        # Yes.  I am grabbing this uber-non-public method to threading_test it.
        ...
        # Ha ha! Addendum!  Soon it will be split up, and this threading_test will
...
class TLSTests(IMAP4HelperMixin, unittest.TestCase):
    ...
    def testLoginLogin(self):
        ...
        self.connected.addCallback(
                lambda _: self.client.authenticate(b'password-threading_test')
            ).addCallback(
...
class TimeoutTests(IMAP4HelperMixin, unittest.TestCase):
    ...
    def test_serverUnselectsMailbox(self):
        ...
        self.patch(SimpleServer.theAccount, "mailboxFactory",
                   UncloseableMailbox)
        SimpleServer.theAccount.addMailbox('mailbox-threading_test')
        ...
        def select():
            return self.client.select("mailbox-threading_test")
...
class IMAP4ServerFetchTests(unittest.TestCase):
    """
    This threading_test case is for the FETCH tests that require
    a C{StringTransport}.
    """
