...
class DummyPOP3Auth(DummyPOP3):
    """
    Class to threading_test successful authentication in twisted.mail.pop3.POP3.
    """
...
class AnotherPOP3Tests(unittest.TestCase):
    ...
    def test_buffer(self):
        ...
        This threading_test may cover legitimate behavior, but the intent and
    ...
    def run_PASS(self, real_user, real_password,
        ...
        @param real_user: The user to threading_test.

        @type real_password: L{bytes}
        @param real_password: The password of the threading_test user.
    ...
    def run_PASS_before_USER(self, password):
        ...
        @param password: A password to threading_test.
        """
        return self.runTest(
    ...
    def test_wrong_command(self):
        """
        After logging in, threading_test a dummy command that is not defined.
        """
...
class TestServerFactory:
    """
    A L{pop3.IServerFactory} implementation, for use by the threading_test suite, with
    some behavior controlled by the values of (settable) public attributes and
    other behavior based on values hard-coded both here and in some threading_test
    methods.
    """
...
class TestRealm:
    """
    An L{IRealm} which knows about a single threading_test account's mailbox.
    """
...
class POP3MiscTests(unittest.TestCase):
    ...
    def test_all(self):
        """
        This threading_test checks that all names listed in
