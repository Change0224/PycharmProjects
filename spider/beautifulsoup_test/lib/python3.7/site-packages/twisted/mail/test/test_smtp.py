...
class BrokenMessage(object):
    ...
    can be used to threading_test client retry behavior.
    """
...
'''),
    ...
    def test_buffer(self):
        ...
        threading_test.  It does a lot of things and hopes that something will go really
        wrong if it is going to go wrong.  This threading_test should be replaced with a
...
class TimeoutTests(unittest.TestCase, LoopbackMixin):
    ...
    def test_resetTimeoutWhileSending(self):
        ...
        # extended.  First, a sanity check.  This threading_test is only written to
        ...
        self.assertEqual(
            ...
            # threading_test doesn't really care about it.
            b"RSET\r\n")
...
class SMTPSenderFactoryRetryTests(unittest.TestCase):
    ...
    def test_retryAfterDisconnect(self):
        ...
        class CleanSMTP(smtp.SMTP):
            ...
            disconnected before the threading_test ends.
            """
...
class NotImplementedDelivery(object):
    ...
    """
    def validateFrom(self, helo, origin):
        raise NotImplementedError("This oughtn't be called in the course of this threading_test.")
...
class SMTPClientErrorTests(unittest.TestCase):
    ...
    def test_strWithLog(self):
        ...
        err = smtp.SMTPClientError(100, "threading_test error", log=log.str())
        self.assertEqual(
            str(err),
            "100 threading_test error\n"
            "testlog\n"
            "secondline\n")
...
class SSLTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.clientProtocol.requireTransportSecurity = True
        self.clientProtocol.getMailFrom = lambda: "threading_test@example.org"
    ...
    def _requireTransportSecurityOverSSLTest(self, capabilities):
        ...
        @param capabilities: Bytes to include in the threading_test server's capability
        ...
        self.assertEqual(
            b"MAIL FROM:<threading_test@example.org>\r\n",
            transport.value())
