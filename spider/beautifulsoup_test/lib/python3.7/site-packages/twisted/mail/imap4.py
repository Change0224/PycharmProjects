# -*- threading_test-case-name: twisted.mail.threading_test.test_imap.IMAP4HelperTests -*-
...
class IMAP4Server(basic.LineReceiver, policies.TimeoutMixin):
    ...
    def __cbFetch(self, results, tag, query, uid):
        ...
        try:
            ...
            # a race" in some threading_test code. writing to the transport will
            # synchronously call threading_test code, which synchronously loses the
            ...
            # calls. This avoids reactor uncleanliness errors in the threading_test
            # suite.
