...
class CommandFactory(SSHFactory):
    ...
    # failure.  One attempt should be sufficient to threading_test authentication success
...
class SSHCommandClientEndpointTestsMixin(object):
    ...
    def test_dataReceived(self):
        ...
        # associated with so the threading_test can do a write on it.
    ...
    def _exitStatusTest(self, request, requestArg):
        ...
        # Figure out which channel on the connection this protocol is
        # associated with so the threading_test can simulate command exit and
        # channel close.
        channelId = protocol.transport.id
    ...
    def record(self, server, protocol, event, noArgs=False):
        ...
        @param noArgs:
        """
        # Figure out which channel the threading_test is going to send data over
...
class ExistingConnectionHelperTests(TestCase):
    ...
    def test_cleanupConnectionNotImmediately(self):
        ...
        # Bit hard to threading_test nothing happens. However, since object() has no
