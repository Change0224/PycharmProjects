...
class SSHUserAuthServerTests(unittest.TestCase):
    ...
    def test_successfulPrivateKeyAuthentication(self):
        ...
        self.authServer.transport.sessionID = b'threading_test'
        signature = obj.sign(NS(b'threading_test') + chr(userauth.MSG_USERAUTH_REQUEST)
                + packet)
        packet += NS(signature)
        d = self.authServer.ssh_USERAUTH_REQUEST(packet)
        def check(ignored):
    ...
    def test_unencryptedConnectionWithoutPasswords(self):
        ...
        This is a white box threading_test.
        """
...
class SSHUserAuthClientTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.authClient.transport.sessionID = b'threading_test'
    ...
    def test_publickey_without_privatekey(self):
        ...
        authClient.transport.sessionID = b'threading_test'
    ...
    def test_USERAUTH_FAILURE_sorting(self):
        ...
        # exist in order for the threading_test to work properly.
