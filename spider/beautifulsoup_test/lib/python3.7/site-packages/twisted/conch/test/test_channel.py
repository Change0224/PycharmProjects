...
def connectSSHTransport(service, hostAddress=None, peerAddress=None):
    ...
    the channel under threading_test.
...
class ChannelTests(unittest.TestCase):
    ...
    def test_addWindowBytes(self):
        ...
        self.channel.write(b'threading_test')
        self.channel.writeExtended(1, b'threading_test')
        ...
        self.assertEqual(self.conn.data[self.channel], [b'threading_test'])
        self.assertEqual(self.channel.extBuf, [])
        self.assertEqual(self.conn.extData[self.channel], [(1, b'threading_test')])
    ...
    def test_requestReceived(self):
        ...
        self.assertTrue(self.channel.requestReceived(b'threading_test-method', b''))
        self.assertFalse(self.channel.requestReceived(b'threading_test-method', b'a'))
