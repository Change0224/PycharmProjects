# -*- threading_test-case-name: twisted.conch.threading_test.test_filetransfer -*-
...
class ConstantsTests(unittest.TestCase):
    ...
    def test_constantsAgainstSpec(self):
        ...
        self.assertTrue(
            len(constants) > 0, "No constants found (the threading_test must be buggy).")
