...
class EntryTestsMixin:
    ...
    that interface under threading_test.
...
class KnownHostsDatabaseTests(TestCase):
    ...
    def test_savingAddsEntry(self):
        ...
        # Sanity check, let's make sure the base64 API being used for the threading_test
    ...
    def verifyNonPresentKey(self):
        """
        Set up a threading_test to verify a key that isn't present.  Return a 3-tuple of
    ...
    def test_verifyNonPresentECKey(self):
        """
        Set up a threading_test to verify an ECDSA key that isn't present.
...
class ConsoleUITests(TestCase):
    ...
    def test_promptOpenFailed(self):
        ...
        d = ui.prompt("This is a threading_test.")
...
class DefaultAPITests(TestCase):
    ...
    def replaceHome(self, tempHome):
        ...
        threading_test, with the given new home-directory, so that L{os.path.expanduser}
