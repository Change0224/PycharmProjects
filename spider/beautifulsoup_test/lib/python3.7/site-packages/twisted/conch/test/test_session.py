...
class StubSessionForStubAvatar(object):
    ...
    variables generally keep track of method invocations so that we can threading_test
...
class EchoTransport:
    ...
    def write(self, data):
        ...
        if b'\x00' in data: # mimic 'exit' for the shell threading_test
            self.loseConnection()
...
class SessionInterfaceTests(unittest.TestCase):
    ...
    def setUp(self):
        """
        Make an SSHSession object to threading_test.  Give the channel some window
...
class WrappersTests(unittest.TestCase):
    """
    A threading_test for the wrapProtocol and wrapProcessProtocol functions.
    """
    if not cryptography:
        skip = "cannot run without cryptography"
...
class SSHSessionProcessProtocolTests(unittest.TestCase):
    ...
    def test_outReceived(self):
        ...
        """
        self.pp.outReceived(b'threading_test data')
        self.assertEqual(self.session.conn.data[self.session],
    ...
    def test_write(self):
        ...
        """
        self.pp.write(b'threading_test data')
        self.assertEqual(self.session.conn.data[self.session],
                [b'threading_test data'])
    ...
    def test_writeSequence(self):
        ...
        """
        self.pp.writeSequence([b'threading_test ', b'data'])
        self.assertEqual(self.session.conn.data[self.session],
                [b'threading_test data'])
    ...
    def test_errReceived(self):
        ...
        """
        self.pp.errReceived(b'threading_test data')
        self.assertEqual(self.session.conn.extData[self.session],
                [(1, b'threading_test data')])
...
class SSHSessionClientTests(unittest.TestCase):
    ...
    def test_dataReceived(self):
        ...
        client.dataReceived(b'threading_test data')
        self.assertEqual(client.transport.buf, b'threading_test data')
