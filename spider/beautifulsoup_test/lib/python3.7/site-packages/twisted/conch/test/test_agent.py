...
class ServerProtocolContractWithFactoryTests(AgentTestBase):
    ...
    across requests.  This threading_test asserts that the protocol raises if its factory
...
class AgentKeyAdditionTests(AgentTestBase):
    ...
    def test_addRSAIdentityNoComment(self):
        ...
        This threading_test asserts that omitting the comment produces an
    ...
    def test_addRSAIdentityWithComment(self):
        ...
        This threading_test asserts that the server receives/stores the comment
