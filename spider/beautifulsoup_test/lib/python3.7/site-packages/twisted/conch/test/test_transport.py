...
class MockCipher(object):
    ...
    """
    outCipType = b'threading_test'
    encBlockSize = 6
    inCipType = b'threading_test'
    decBlockSize = 6
    inMACType = b'threading_test'
    outMACType = b'threading_test'
    verifyDigestSize = 1
    usedEncrypt = False
    usedDecrypt = False
    outMAC = (None, b'', b'', 1)
...
class TransportTestCase(unittest.TestCase):
    """
    Base class for transport threading_test cases.
    """
    klass = None
...
class BaseSSHTransportTests(BaseSSHTransportBaseCase, TransportTestCase):
    ...
    def test_sendKexInitBlocksOthers(self):
        ...
        # Drop all the bytes sent by setUp, they're not relevant to this threading_test.
        self.transport.clear()
    ...
    def test_sendDebug(self):
        ...
        Test that debug messages are sent correctly.  Payload::
            ...
            string language
        """
        self.proto.sendDebug(b"threading_test", True, b'en')
        self.assertEqual(
            self.packets,
            [(transport.MSG_DEBUG,
    ...
    def test_receiveDebug(self):
        ...
        self.assertEqual(
            self.proto.debugs,
            [(True, b'threading_test', b'en'), (False, b'silent', b'en')])
    ...
    def test_sendIgnore(self):
        ...
        Test that ignored messages are sent correctly.  Payload::
            string ignored data
        """
        self.proto.sendIgnore(b"threading_test")
        self.assertEqual(
    ...
    def test_receiveIgnore(self):
        ...
        test_sendIgnore.
        """
        self.proto.dispatchMessage(transport.MSG_IGNORE, b'threading_test')
        self.assertEqual(self.proto.ignoreds, [b'threading_test'])
    ...
    def test_sendDisconnect(self):
        ...
        self.proto.sendDisconnect(0xff, b"threading_test")
        self.assertEqual(
            self.packets,
    ...
    def test_receiveDisconnect(self):
        ...
        self.assertEqual(self.proto.errors, [(255, b'threading_test')])
        self.assertTrue(disconnected[0])
    ...
    def test_service(self):
        ...
        self.proto.dispatchMessage(0xff, b"threading_test")
        self.assertEqual(self.packets, [(0xff, b"threading_test")])
...
class ServerAndClientSSHTransportBaseCase:
    ...
    def connectModifiedProtocol(self, protoModification,
            kind=None):
        """
        Helper function to connect a modified protocol to the threading_test protocol
        and threading_test for disconnection.
        """
        if kind is None:
...
class SSHCiphersTests(unittest.TestCase):
    ...
    def test_makeMAC(self):
        ...
        """
        # Use the threading_test vectors given in the appendix of RFC 2104.
        vectors = [
            (b"\x0b" * 16, b"Hi There",
        ...
        for key, data, mac in vectors:
            ...
            self.assertEqual(
                ...
                "Failed HMAC threading_test vector; key=%r data=%r" % (key, data))
