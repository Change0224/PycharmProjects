...
class EventAsTextTests(unittest.TestCase):
    ...
    def test_eventWithTraceback(self):
        ...
        event = {
            "log_format": u"This is a threading_test log message"
        }
        event["log_failure"] = f
        ...
        self.assertIn(u'This is a threading_test log message', eventText)
    ...
    def test_eventAsTextSystemMissingNamespaceAndLevel(self):
        ...
        event = {
            ...
            "log_namespace": u'threading_test',
        }
        event["log_failure"] = f
        eventText = eventAsText(
            event,
