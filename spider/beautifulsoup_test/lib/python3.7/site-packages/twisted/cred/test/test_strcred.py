...
class SSHCheckerTests(unittest.TestCase):
    ...
    L{twisted.conch.threading_test.test_checkers.SSHPublicKeyCheckerTestCase}.
    """
...
class CheckerOptionsTests(unittest.TestCase):
    ...
    def test_invalidAuthError(self):
        ...
        # threading_test should still run.
...
class LimitingInterfacesTests(unittest.TestCase):
    ...
    threading_test, we use IUsernameHashedPassword, although this will never
    ...
    I should note that, at first, this threading_test is counter-intuitive,
    ...
    def test_helpAuthTypeLimitsOutput(self):
        ...
        """
        options = OptionsForUsernamePassword()
        # Find an interface that we can use for our threading_test
        invalidFactory = None
