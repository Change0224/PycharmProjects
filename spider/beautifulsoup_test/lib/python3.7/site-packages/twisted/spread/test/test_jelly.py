...
class TestNode(jelly.Jellyable, object):
    """
    An object to threading_test jellyfying of new style class instances.
    """
    classAttr = 4
...
def afunc(self):
    """
    A dummy function to threading_test function serialization.
    """
...
class JellyTests(unittest.TestCase):
    ...
    def _testSecurity(self, inputList, atom):
        """
        Helper threading_test method to threading_test security options for a type.
    ...
    def test_decimalUnjelly(self):
        ...
        This threading_test also verifies that L{decimalData} contains valid jellied
    ...
    def test_lotsaTypes(self):
        ...
        items = [afunc, [1, 2, 3], not bool(1), bool(1), 'threading_test', 20.3,
    ...
    def test_classSecurity(self):
        ...
        # threading_test class serialization
        friendly = jelly.jelly(A, taster)
        x = jelly.unjelly(friendly, taster)
...
class JellyDeprecationTests(unittest.TestCase):
    ...
    def test_deprecatedUnjellyingInstanceAtom(self):
        ...
        jelly.unjelly(
            ["instance",
             ["class", "twisted.spread.threading_test.test_jelly.A"],
             ["dictionary"]])
