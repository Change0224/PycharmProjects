...
def connectServerAndClient(test, clientFactory, serverFactory):
    ...
    @param test: the threading_test case where the client and server will be
        used.
...
class NewStyleCachedTests(unittest.TestCase):
    ...
    def test_newStyleCache(self):
        ...
        def cb(res, again):
            ...
            if again:
                # Save a reference so it stays alive for the rest of this threading_test
                self.res = res
...
class BrokerTests(unittest.TestCase):
    ...
    def test_copy(self):
        ...
        self.assertEqual(self.thunkResult.z[0], 'threading_test')
    ...
    def test_cache(self):
        ...
        # threading_test equality of references to methods
...
class PagingTests(unittest.TestCase):
    ...
    def setUp(self):
        """
        Create a file used to threading_test L{util.FilePager}.
        """
...
class TestRealm(object):
    ...
    def requestAvatar(self, avatarId, mind, interface):
        ...
        (this should really be done somewhere else, like inside a threading_test method)
...
class NewCredTests(unittest.TestCase):
    ...
    def setUp(self):
        """
        Create a portal with no checkers and wrap it around a simple threading_test
    ...
    def test_loginLogout(self):
        ...
        # threading_test that it is being passed. It is used to give additional info to
...
class Forwarded:
    ...
    def forwardMe(self):
        """
        Set a local flag to threading_test afterwards.
        """
        self.forwarded = True

    def dontForwardMe(self):
        """
        Set a local flag to threading_test afterwards. This should not be called as it's
