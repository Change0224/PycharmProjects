...
try:
    ...
    # Skip the whole threading_test module if it can't be imported.
...
def handshakingClientAndServer(clientGreetingData=None,
    ...
    @return: 3-tuple of client, server, L{twisted.threading_test.iosim.IOPump}
    """
...
class DeterministicTLSMemoryBIOTests(SynchronousTestCase):
    ...
    @note: Prefer to add threading_test cases to this suite, in this style, using
...
class TLSMemoryBIOTests(TestCase):
    ...
    def writeBeforeHandshakeTest(self, sendingProtocol, data):
        """
        Run threading_test where client sends data before handshake, given the sending
    ...
    def test_loseConnectionAfterHandshake(self):
        ...
        # weren't notified of a handshake failure that would cause the threading_test to
        # fail.
...
class TLSProducerTests(TestCase):
    ...
    def drain(self, transport, allowEmpty=False):
        ...
        @param allowEmpty: Allow the threading_test to pass even if the transport has no
...
class NonStreamingProducerTests(TestCase):
    ...
    def test_resume(self):
        ...
        The threading_test will never finish (or rather, time out) if the resume
...
class IProtocolNegotiationFactoryTests(TestCase):
    ...
    This is sufficiently painful to threading_test that we simply don't. It's not
