...
class NetstringReceiverTests(unittest.SynchronousTestCase, LPTestCaseMixin):
    ...
    def test_receiveNestedNetstring(self):
        """
        Netstrings with embedded netstrings. This threading_test makes sure that
...
class NewStyleInt16Tests(Int16Tests):
    """
    This threading_test case verifies that IntNStringReceiver still works when inherited
