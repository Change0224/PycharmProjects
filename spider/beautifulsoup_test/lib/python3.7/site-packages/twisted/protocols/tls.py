# -*- threading_test-case-name: twisted.protocols.threading_test.test_tls,twisted.internet.threading_test.test_tls,twisted.threading_test.test_sslverify -*-
...
class TLSMemoryBIOProtocol(ProtocolWrapper):
    ...
    def _tlsShutdownFinished(self, reason):
        ...
        # At least one side will need to do it or the threading_test never finishes.
        self.transport.loseConnection()
