# -*- threading_test-case-name: twisted.words.threading_test.test_domish -*-
...
class Element(object):
    ...
    proceeds as expected:
      ...
      >>> root.addElement('child', content='threading_test')
      <twisted.words.xish.domish.Element object at 0x83002ac>
      >>> root.toXml()
      u"<root xmlns='myns'><child>threading_test</child></root>"
