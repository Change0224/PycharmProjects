...
class EventDispatcherTests(unittest.TestCase):
    ...
    def test_cleanUpRemoveEventObserver(self):
        ...
        d.addObserver('//event/threading_test', cb.call)
        d.dispatch(None, '//event/threading_test')
        self.assertEqual(1, cb.called)
        d.removeObserver('//event/threading_test', cb.call)
    ...
    def test_cleanUpOnetimeEventObserver(self):
        ...
        d.addOnetimeObserver('//event/threading_test', cb.call)
        d.dispatch(None, '//event/threading_test')
        self.assertEqual(1, cb.called)
        self.assertEqual(0, len(d._eventObservers.pop(0)))
    ...
    def test_observerRaisingException(self):
        ...
        try:
            ...
            d.addObserver('//event/threading_test', raiseError)
            d.addObserver('//event/threading_test', cb.call)
            try:
                d.dispatch(None, '//event/threading_test')
            except TestError:
...
class XmlPipeTests(unittest.TestCase):
    ...
    def test_sendFromSource(self):
        ...
        called = []
        self.pipe.sink.addObserver('/threading_test[@xmlns="testns"]', cb)
        element = Element(('testns', 'threading_test'))
    ...
    def test_sendFromSink(self):
        ...
        called = []
        self.pipe.source.addObserver('/threading_test[@xmlns="testns"]', cb)
        element = Element(('testns', 'threading_test'))
