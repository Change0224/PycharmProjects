...
class SerializerTests(unittest.TestCase):
    ...
    def test_prefixesReuse(self):
        ...
        This threading_test makes sure that passing a dictionary of prefixes repeatedly
        ...
        # threading_test passing of dictionary
        s = domish.SerializerClass(prefixes=prefixes)
        self.assertNotIdentical(prefixes, s.prefixes)

        # threading_test proper serialization on prefixes reuse
    ...
    def testUnicodeSerialization(self):
        e = domish.Element((None, "foo"))
        e["threading_test"] = u"my value\u0221e"
        e.addContent(u"A degree symbol...\u00B0")
        self.assertEqual(e.toXml(),
                          u"<foo threading_test='my value\u0221e'>A degree symbol...\u00B0</foo>")
