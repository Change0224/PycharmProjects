...
class RealmTests(unittest.TestCase):
    def _entityCreationTest(self, kind):
        ...
        name = u'threading_test' + kind.lower()
    ...
    def testGroupUsernameCollision(self):
        ...
        self.successResultOf(realm.createUser(u"threading_test"))
        self.successResultOf(realm.createGroup(u"threading_test"))
...
class IRCProtocolTests(unittest.TestCase):
    ...
    def testGetTopic(self):
        ...
        group.meta["topic"] = "This is a threading_test topic."
        ...
        self.assertEqual(response[3][2], ['useruser', '#somechannel', 'This is a threading_test topic.'])
        self.assertEqual(response[4][1], '333')
        ...
        self.assertEqual(response[0][2], ['useruser', '#somechannel', 'This is a threading_test topic.'])
