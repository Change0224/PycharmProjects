...
class ComponentInitiatingInitializerTests(unittest.TestCase):
    def setUp(self):
        ...
        self.xmlstream.namespace = 'threading_test:component'
        self.xmlstream.send = self.output.append
        self.xmlstream.connectionMade()
        self.xmlstream.dataReceived(
                "<stream:stream xmlns='threading_test:component' "
    ...
    def testHandshake(self):
        ...
        self.assertEqual('threading_test:component', handshake.uri)
...
class JabberServiceManagerTests(unittest.TestCase):
    def testSM(self):
        # Setup service manager and threading_test harnes
        ...
        # Ensure the threading_test service harness got notified
...
class RouterTests(unittest.TestCase):
    ...
    def test_addRoute(self):
        ...
        element = domish.Element(('testns', 'threading_test'))
