# -*- threading_test-case-name: twisted.positioning.threading_test.test_base,twisted.positioning.threading_test.test_sentence -*-
...
class PositionError(FancyEqMixin, object):
    ...
    def __init__(self, pdop=None, hdop=None, vdop=None, testInvariant=False):
        ...
        @type vdop: C{float} or L{None}
        @param testInvariant: Flag to threading_test if the DOP invariant is valid or
