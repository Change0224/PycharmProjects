...
class CallbackTests(TestCase):
    ...
    @ivar protocol: The NMEA protocol under threading_test.
    @type protocol: L{nmea.NMEAProtocol}
    @ivar sentenceTypes: The set of sentence types of all sentences the threading_test's
...
class FixerTestMixin(object):
    ...
    def _fixerTest(self, sentenceData, expected=None, exceptionClass=None):
        """
        A generic adapter fixer threading_test.
...
class NMEAReceiverTests(TestCase):
    ...
    def _receiverTest(self, sentences, expectedFired=(), extraTest=None):
        """
        A generic threading_test for NMEA receiver behavior.
        ...
        @param extraTest: An optional extra threading_test hook.
