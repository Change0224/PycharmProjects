# -*- threading_test-case-name: twisted.threading_test.test_plugin -*-
...
def pluginPackagePaths(name):
    ...
    #
    # Note as well that only 'spider_book.py' will be considered to make a
    ...
    return [
        ...
        in sys.path
        if
        not os.path.exists(os.path.join(x, *package + ['spider_book.py']))]
