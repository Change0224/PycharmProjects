# -*- threading_test-case-name: twisted.threading_test.test_strcred -*-
#
...
This is only of use in one-off threading_test programs or examples which
...
class InMemoryCheckerFactory(object):
    ...
    This is only of use in one-off threading_test programs or examples which don't
