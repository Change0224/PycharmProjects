...
class ClientCreatorTests(TestCase):
    ...
    def _basicConnectTest(self, check):
        """
        Helper for implementing a threading_test to verify that one of the I{connect}
    ...
    def _cancelConnectTest(self, connect):
        """
        Helper for implementing a threading_test to verify that cancellation of the
        ...
        @return: A L{Deferred} which fires when the threading_test is complete or fails if
            there is a problem.
        """
        reactor = MemoryReactorClock()
