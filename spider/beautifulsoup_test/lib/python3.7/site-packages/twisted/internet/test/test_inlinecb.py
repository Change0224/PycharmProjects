# -*- threading_test-case-name: twisted.internet.threading_test.test_inlinecb -*-
...
Some tests for inlineCallbacks are defined in L{twisted.threading_test.test_defgen} as
well.
"""
...
class ForwardTraceBackTests(SynchronousTestCase):
    ...
    def test_forwardTracebacks(self):
        ...
        A first simple threading_test with a couple of inline callbacks.
        """
    ...
    def test_forwardLotsOfTracebacks(self):
        ...
        A wider threading_test with a 4 chained inline callbacks.
        ...
        Note that the previous threading_test is testing the simple case, and this one is
