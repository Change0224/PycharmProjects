...
pemPath = getModule("twisted.threading_test").filePath.sibling("server.pem")
noTrailingNewlineKeyPemPath = getModule("twisted.threading_test").filePath.sibling(
    "key.pem.no_trailing_newline")
noTrailingNewlineCertPemPath = getModule("twisted.threading_test").filePath.sibling(
...
class ClientEndpointTestCaseMixin(object):
    """
    Generic threading_test methods to be mixed into all client endpoint threading_test classes.
    """
...
class EndpointTestCaseMixin(ServerEndpointTestCaseMixin,
    ...
    """
    Generic threading_test methods to be mixed into all endpoint threading_test classes.
    """
...
class ProcessEndpointTransportTests(unittest.TestCase):
    ...
    def test_write(self):
        ...
        """
        self.endpointTransport.write(b'threading_test')
        self.assertEqual(self.process.io.getvalue(), b'threading_test')
...
class SimpleHostnameResolverTests(unittest.SynchronousTestCase):
    ...
    @ivar resolver: The instance to threading_test.
...
class _HostnameEndpointMemoryReactorMixin(ClientEndpointTestCaseMixin):
    ...
    def expectedClients(self, reactor):
        ...
        @param reactor: The L{MemoryReactor} under threading_test.
...
class ServerStringTests(unittest.TestCase):
    ...
    def test_typeFromPlugin(self):
        ...
        # this threading_test.
        addFakePlugin(self)
        # Plugin is set up: now actually threading_test.
        notAReactor = object()
...
class AdoptedStreamServerEndpointTests(ServerEndpointTestCaseMixin,
    ...
    def createServerEndpoint(self, reactor, factory):
        """
        Create a new L{AdoptedStreamServerEndpoint} for use by a threading_test.
...
class SystemdEndpointPluginTests(unittest.TestCase):
    ...
    def _parseStreamServerTest(self, addressFamily, addressFamilyString):
        ...
        problem a threading_test-failing exception will be raised.
...
class WrapClientTLSParserTests(unittest.TestCase):
    ...
    def test_tls(self):
        ...
        # about this stuff from how the context behaves.  So this threading_test is an
        # integration threading_test.

        # There are good examples of how to construct relevant threading_test-fixture
        # data in
        # twisted.threading_test.test_sslverify.certificatesForAuthorityAndServer; that
        # more directly tests the nuances of this code.  Remember that this
        # should threading_test both positive and negative cases.
