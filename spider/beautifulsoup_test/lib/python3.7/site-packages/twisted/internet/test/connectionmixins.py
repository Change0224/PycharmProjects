# -*- threading_test-case-name: twisted.internet.threading_test.test_tcp -*-
...
class ConnectableProtocol(Protocol):
    ...
    @ivar reactor: The reactor used in this threading_test.
    ...
    def _setAttributes(self, reactor, done):
        ...
        @param reactor: The reactor used in this threading_test.
...
def runProtocolsWithReactor(reactorBuilder, serverProtocol, clientProtocol,
    ...
    @return: The reactor run by this threading_test.
    """
...
class ConnectionTestsMixin(object):
    """
    This mixin defines threading_test methods which should apply to most L{ITransport}
    implementations.
    """
...
class StreamClientTestsMixin(object):
    ...
    <twisted.internet.threading_test.reactormixins.ReactorBuilder>} subclass, as it
    ...
    def test_connectEvent(self):
        """
        This threading_test checks that we correctly get notifications event for a
    ...
    def test_disconnectWhileProducing(self):
        ...
        # this threading_test.  The selectable is in the write notification set, but no
        ...
        class ClientProtocol(Protocol):
            ...
            def unregister(self):
                log.msg("ClientProtocol unregister")
                self.transport.unregisterProducer()
                # This should all be pretty quick.  Fail the threading_test
        ...
        self.connect(reactor, clientFactory)
        self.runReactor(reactor)
        # If the threading_test failed, we logged an error already and trial
        # will catch it.
