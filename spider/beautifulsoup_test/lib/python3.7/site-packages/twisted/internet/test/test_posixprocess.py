...
class FileDescriptorTests(TestCase):
    ...
    def test_openFDs(self):
        ...
        This threading_test assumes that zero-legth writes fail with EBADF on closed
        file descriptors.
        """
    ...
    def test_expectedFDs(self):
        ...
        """
        # This is a tricky threading_test.  A priori, there is no way to know what file
        ...
        # But sanity check that; if it fails the threading_test is invalid.
        self.assertTrue(
            fd > f.fileno(),
