...
class SetWakeupSIGCHLDTests(SynchronousTestCase):
    ...
    def setUp(self):
        ...
        if self.signalModuleHandler is not None and self.oldFD != -1:
            msg("Previous threading_test didn't clean up after its SIGCHLD setup: %r %r"
    ...
    def tearDown(self):
        ...
        # Now restore whatever the setup was before the threading_test ran.
