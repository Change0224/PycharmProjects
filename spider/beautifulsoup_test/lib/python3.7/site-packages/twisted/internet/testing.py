# -*- threading_test-case-name: twisted.internet.threading_test.test_testing -*-
...
class StringTransport:
    ...
    @ivar _lenient: By default L{StringTransport} enforces that
        ...
        However, if your threading_test case is calling L{resumeProducing} after
...
class EventLoggingObserver(Sequence):
    ...
    def createWithCleanup(cls, testInstance, publisher):
        ...
        @return: An EventLoggingObserver configured to observe the provided
            publisher.
        @rtype: L{twisted.threading_test.proto_helpers.EventLoggingObserver}
        """
        obs = cls()
