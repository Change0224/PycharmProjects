# -*- threading_test-case-name: twisted.internet.threading_test.test_inotify -*-
...
class INotify(FileDescriptor, object):
    ...
    def __init__(self, reactor=None):
        ...
        # it and threading_test for the system errors.
    ...
    def _addChildren(self, iwp):
        ...
        try:
            ...
            # Somebody or something (like a threading_test) removed this directory while
