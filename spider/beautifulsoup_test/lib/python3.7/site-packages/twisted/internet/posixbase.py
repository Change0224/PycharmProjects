# -*- threading_test-case-name: twisted.threading_test.test_internet,twisted.internet.threading_test.test_posixbase -*-
    ...
    def wakeUp(self):
        ...
        if self.o is not None:
            try:
                ...
                # XXX There is no unit threading_test for raising the exception
