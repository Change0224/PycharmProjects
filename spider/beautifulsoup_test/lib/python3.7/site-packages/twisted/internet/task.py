# -*- threading_test-case-name: twisted.threading_test.test_task,twisted.threading_test.test_cooperator -*-
...
class LoopingCall:
    ...
    def _scheduleFrom(self, when):
        ...
        def howLong():
            ...
            # number is effectively zero.  However, we can't just threading_test against
