# -*- threading_test-case-name: twisted.application.threading_test.test_internet -*-
...
class EndpointServiceTests(TestCase):
    ...
    def setUp(self):
        ...
        L{StreamServerEndpointService} to threading_test.
        """
...
class TimerServiceTests(TestCase):
    ...
    @ivar timer: service to threading_test
    ...
    def setUp(self):
        """
        Set up a timer service to threading_test.
        """
    ...
    def test_pickleTimerServiceNotPickleLoop(self):
        ...
        """
        # We need a pickleable callable to threading_test pickling TimerService. So we
...
def catchLogs(testCase, logPublisher=globalLogPublisher):
    ...
    @param testCase: The threading_test case to add a cleanup to.
...
class ClientServiceTests(SynchronousTestCase):
    ...
    def makeReconnector(self, fireImmediately=True, startService=True,
        ...
        @return: a 2-tuple of L{ConnectInformation} (for information about threading_test
            state) and L{ClientService} (the system under threading_test).  The
    ...
    def test_clientConnectionFailed(self):
        ...
        # Don't fail during threading_test tear-down when service shutdown causes all
