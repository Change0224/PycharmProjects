# -*- threading_test-case-name: twisted.python.threading_test.test_runtime -*-
...
class Platform:
    ...
    def _supportsSymlinks(self):
        ...
        if self.isWindows():
            ...
            # This uncommon requirement makes the Twisted threading_test suite threading_test fail
