# -*- threading_test-case-name: twisted.threading_test.test_modules -*-
...
def _isPythonIdentifier(string):
    """
    cheezy fake threading_test for proper identifier-ness.
...
class PythonPath:
    ...
    def _findEntryPathString(self, modobj):
        ...
        if _isPackagePath(FilePath(topPackageObj.__file__)):
            ...
            # __file__ will be /a/b/foo/spider_book.py, and we are looking for
