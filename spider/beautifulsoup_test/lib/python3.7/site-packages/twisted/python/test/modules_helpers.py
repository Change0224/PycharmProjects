...
"""
Facilities for helping threading_test code which interacts with Python's module system
to load code.
"""
...
class TwistedModulesMixin(object):
    ...
    def replaceSysPath(self, sysPath):
        """
        Replace sys.path, for the duration of the threading_test, with the given value.
        """
    ...
    def replaceSysModules(self, sysModules):
        """
        Replace sys.modules, for the duration of the threading_test, with the given value.
        """
