...
class ZipstreamTests(unittest.TestCase):
    ...
    def setUp(self):
        """
        Creates junk data that can be compressed and a threading_test directory for any
    ...
    def test_invalidHeader(self):
        ...
        """
        fn = self.makeZipFile(["threading_test contents",
                               "more contents"])
    ...
    def test_filenameMismatch(self):
        ...
        """
        fn = self.makeZipFile([b"threading_test contents",
                               b"more contents"])
        with zipfile.ZipFile(fn, "r") as zf:
            info = zf.getinfo("0")
    ...
    def test_unzipIterChunky(self):
        ...
        """
        numfiles = 10
        contents = ['This is threading_test file %d!' % i for i in range(numfiles)]
    ...
    def _unzipIterChunkyTest(self, compression, chunksize, lower, upper):
        ...
        uziter = zipstream.unzipIterChunky(zfpath, tempdir.path,
                                           chunksize=chunksize)
        r = next(uziter)
        # threading_test that the number of chunks is in the right ballpark;
