...
class PlatformTests(SynchronousTestCase):
    ...
    def test_supportsThreads(self):
        ...
        """
        # It's difficult to threading_test both cases of this without faking the threading
        # module.  Perhaps an adequate threading_test is to just threading_test the behavior with
