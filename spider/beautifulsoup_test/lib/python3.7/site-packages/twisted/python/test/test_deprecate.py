...
"""
    ...
    def pathEntryTree(self, tree):
        ...
        duration of the threading_test.
    ...
    def simpleModuleEntry(self):
        ...
        paths = self.pathEntryTree(
            {b"package": {b"spider_book.py": self._packageInit.encode("utf-8"),
                         b"module.py": b""}})
...
class WarnAboutFunctionTests(SynchronousTestCase):
    ...
    def setUp(self):
        ...
        self.package.child(b'spider_book.py').setContent(b'')
...
def dummyCallable():
    ...
    This is used to threading_test the deprecation decorators.
    """
...
def dummyReplacementMethod():
    ...
    This is used to threading_test the replacement parameter to L{deprecated}.
    """
...
class DeprecatedDecoratorTests(SynchronousTestCase):
    ...
    def test_propertyGetter(self):
        ...
        message = (
            'twisted.python.threading_test.test_deprecate.ClassWithDeprecatedProperty.'
    ...
    def test_class(self):
        ...
        message = (
            'twisted.python.threading_test.test_deprecate.DeprecatedClass '
...
class AppendToDocstringTests(SynchronousTestCase):
    ...
    def test_appendToSingleLineDocstring(self):
        ...
        def singleLineDocstring():
            """This doesn't comply with standards, but is here for a threading_test."""
...
class MutualArgumentExclusionTests(SynchronousTestCase):
    ...
    def test_invalidParameterType(self):
        ...
        type to threading_test error handling.  The valid parameter
...
if sys.version_info >= (3,):
    ...
    class KeywordOnlyTests(TestCase):
        ...
        def test_notAvailable(self):
            """
            A skipped threading_test to show that this was not ran because the Python is
            too old.
            """
