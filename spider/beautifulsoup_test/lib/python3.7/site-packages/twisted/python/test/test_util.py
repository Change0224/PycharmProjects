# -*- threading_test-case-name: twisted.python.threading_test.test_util
...
class GetPasswordTests(unittest.TestCase):
    if not IReactorProcess.providedBy(reactor):
        skip = "Process support required to threading_test getPassword"
...
class ReplaceIfTests(unittest.TestCase):
    ...
    def test_replacesIfTrue(self):
        ...
        self.assertEqual(test.__name__, "threading_test")
        self.assertEqual(test.__module__, "twisted.python.threading_test.test_util")
