...
class RegistryUsingMixin(object):
    """
    Mixin for threading_test cases which modify the global registry somehow.
    """
    def setUp(self):
        """
        Configure L{twisted.python.components.registerAdapter} to mutate an
        alternate registry to improve threading_test isolation.
        """
        ...
        # away at the end of the threading_test.
        ...
        # association is also discarded after the threading_test.
...
class ComponentizedTests(unittest.SynchronousTestCase, RegistryUsingMixin):
    """
    Simple threading_test case for caching in Componentized.
    """
    def setUp(self):
...
class IAttrX(Interface):
    """
    Base interface for threading_test of adapter with C{__cmp__}.
    """
    def x():
        """
        Return a value.
...
class IAttrXX(Interface):
    """
    Adapted interface for threading_test of adapter with C{__cmp__}.
    """
    def xx():
        """
...
class Xcellent(object):
    """
    L{IAttrX} implementation for threading_test of adapter with C{__cmp__}.
    """
    def x(self):
        """
        Return a value.
...
class ProxyForInterfaceTests(unittest.SynchronousTestCase):
    ...
    def test_multipleMethods(self):
        """
        [Regression threading_test] The proxy should send its method calls to the correct
    ...
    def test_proxyName(self):
        ...
        self.assertEqual(
            proxy.__name__,
            "(Proxy for "
            "twisted.python.threading_test.test_components.IProxiedInterface)")
    ...
    def test_proxyDescriptorGet(self):
        ...
        actually use the 'type' argument at all, this threading_test calls it the
