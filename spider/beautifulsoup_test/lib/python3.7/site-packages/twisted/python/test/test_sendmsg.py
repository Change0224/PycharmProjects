...
if platform.isLinux():
    ...
    # It would be nice to be able to threading_test flags on more platforms, but finding
...
def _spawn(script, outputFD):
    """
    Start a script that is a peer of this threading_test as a subprocess.
...
class CModuleGetSocketFamilyTests(TestCase):
    ...
    def _socket(self, addressFamily):
        ...
        the threading_test is torn down.
        """
