# -*- threading_test-case-name: twisted.python.threading_test.test_setup -*-
...
_EXTENSIONS = [
    ConditionalExtension(
        "twisted.threading_test.raiser",
        sources=["src/twisted/threading_test/raiser.c"],
...
notPortedModules = [
    ...
    "twisted.mail.tap",
    "twisted.mail.threading_test.test_bounce",
    "twisted.mail.threading_test.test_mail",
    "twisted.mail.threading_test.test_options",
    "twisted.mail.threading_test.test_scripts",
    "twisted.news.__init__",
    "twisted.news.database",
    "twisted.news.news",
    "twisted.news.nntp",
    "twisted.news.tap",
    "twisted.news.threading_test.__init__",
    "twisted.news.threading_test.test_database",
    "twisted.news.threading_test.test_news",
    "twisted.news.threading_test.test_nntp",
    ...
    "twisted.python.hook",
    "twisted.python.threading_test.cmodulepullpipe",
    "twisted.python.threading_test.test_pydoctor",
    "twisted.python.threading_test.test_win32",
    "twisted.threading_test.test_hook",
    "twisted.web.soap",
    "twisted.web.threading_test.test_soap",
]
