...
class DistTrialRunnerTests(TestCase):
    ...
    def test_runUsedDirectory(self):
        """
        L{DistTrialRunner} checks if the threading_test directory is already locked, and
    ...
    def test_runWithoutTest(self):
        """
        When the suite contains no threading_test, L{DistTrialRunner} takes a shortcut
        ...
        self.assertIn("Running 0 threading_test", output)
        self.assertIn("PASSED", output)


    def test_runWithoutTestButWithAnError(self):
        """
        Even if there is no threading_test, the suite can contain an error (most likely,
    ...
    def test_runUnexpectedError(self):
        """
        If for some reasons we can't connect to the worker process, the threading_test
    ...
    def test_runStopAfterTests(self):
        """
        L{DistTrialRunner} calls C{reactor.stop} and unlocks the threading_test directory
    ...
    def test_runWaitForProcessesDeferreds(self):
        ...
        reactor is stopping, and then unlocks the threading_test directory, not trying to
