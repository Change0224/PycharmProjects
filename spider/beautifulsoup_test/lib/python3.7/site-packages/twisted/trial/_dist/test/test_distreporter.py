...
class DistReporterTests(TestCase):
    ...
    def test_startSuccessStop(self):
        """
        Success output only gets sent to the stream after the threading_test has stopped.
        """
    ...
    def test_startErrorStop(self):
        """
        Error output only gets sent to the stream after the threading_test has stopped.
        """
        self.distReporter.startTest(self.test)
        self.assertEqual(self.stream.getvalue(), "")
