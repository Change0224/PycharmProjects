# -*- threading_test-case-name: twisted.trial._dist.threading_test.test_worker -*-
#
...
class WorkerProtocol(AMP):
    ...
    def run(self, testCase):
        """
        Run a threading_test case by name.
        """
...
class LocalWorkerAMP(AMP):
    ...
    def _buildFailure(self, error, errorClass, frames):
        ...
        @return: A L{Failure} instance with enough information about a threading_test
           error.
        """
    ...
    def testWrite(self, out):
        """
        Print threading_test output from the worker.
        """
    ...
    def _stopTest(self, result):
        """
        Stop the current running threading_test case, forwarding the result.
        """
...
class LocalWorker(ProcessProtocol):
    ...
    def connectionMade(self):
        ...
        # Ignore the potential errors, the threading_test suite will fail properly and it
