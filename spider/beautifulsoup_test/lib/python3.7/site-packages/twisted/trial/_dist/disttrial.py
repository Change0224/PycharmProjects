# -*- threading_test-case-name: twisted.trial._dist.threading_test.test_disttrial -*-
...
class DistTrialRunner(object):
    ...
    def writeResults(self, result):
        """
        Write threading_test run final outcome to result.
    ...
    def run(self, suite, reactor=None, cooperate=cooperate,
        ...
        @return: The threading_test result.
        ...
        if not count:
            # Take a shortcut if there is no threading_test
