...
class LocalWorkerAMPTests(TestCase):
    ...
    def test_runSuccess(self):
        """
        Run a threading_test, and succeed.
        """
        results = []
    ...
    def test_runExpectedFailure(self):
        """
        Run a threading_test, and fail expectedly.
        """
        results = []
    ...
    def test_runError(self):
        """
        Run a threading_test, and encounter an error.
        """
        results = []
    ...
    def test_runSkip(self):
        """
        Run a threading_test, but skip it.
        """
        results = []
    ...
    def test_runUnexpectedSuccesses(self):
        """
        Run a threading_test, and succeed unexpectedly.
        """
        results = []
    ...
    def test_testWrite(self):
        """
        L{LocalWorkerAMP.testWrite} writes the data received to its threading_test
        stream.
        """
        results = []
    ...
    def test_stopAfterRun(self):
        """
        L{LocalWorkerAMP.run} calls C{stopTest} on its threading_test result once the
...
class LocalWorkerTests(TestCase):
    ...
    def test_childDataReceived(self):
        ...
        """
        localWorker = self.tidyLocalWorker(FakeAMProtocol(), '.', 'threading_test.log')
    ...
    def test_processEnded(self):
        ...
        localWorker = LocalWorker(protocol, '.', 'threading_test.log')
    ...
    def test_startError(self):
        ...
        self.tidyLocalWorker(protocol, '.', 'threading_test.log')
