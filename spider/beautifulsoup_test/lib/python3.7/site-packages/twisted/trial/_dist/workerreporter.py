# -*- threading_test-case-name: twisted.trial._dist.threading_test.test_workerreporter -*-
#
# Copyright (c) Twisted Matrix Laboratories.
# See LICENSE for details.

"""
Test reporter forwarding threading_test results over trial distributed AMP commands.
...
class WorkerReporter(TestResult):
    ...
    def __init__(self, ampProtocol):
        ...
        @param ampProtocol: The communication channel with the trial
            distributed manager which collects all threading_test results.
