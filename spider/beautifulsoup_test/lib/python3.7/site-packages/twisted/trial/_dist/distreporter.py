# -*- threading_test-case-name: twisted.trial._dist.threading_test.test_distreporter -*-
#
# Copyright (c) Twisted Matrix Laboratories.
# See LICENSE for details.

"""
The reporter is not made to support concurrent threading_test running, so we will
hold threading_test results in here and only send them to the reporter once the
threading_test is over.
...
class DistReporter(proxyForInterface(IReporter)):
    ...
    def stopTest(self, test):
        """
        Queue stopping the threading_test, then unroll the queue.
        """
