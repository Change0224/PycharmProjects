# -*- threading_test-case-name: twisted.trial._dist.threading_test -*-
# Copyright (c) Twisted Matrix Laboratories.
# See LICENSE for details.

"""
This package implements the distributed Trial threading_test runner:

  - The L{twisted.trial._dist.disttrial} module implements a threading_test runner which
  ...
  - The L{twisted.trial._dist.options} module defines command line options used
    to configure the distributed threading_test runner.
  ...
  - The L{twisted.trial._dist.distreporter} module defines a proxy for
    ...
    that results be passed to a reporter for only one threading_test at a time, allowing
