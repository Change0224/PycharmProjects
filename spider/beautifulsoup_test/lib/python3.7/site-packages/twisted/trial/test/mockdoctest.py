...
# this module is a trivial class with doctests to threading_test trial's doctest
# support.
...
class Counter(object):
    ...
    def __eq__(self, other):
        """equality operator, compare other to my value()
           ...
           >>> c += 10
           >>> c.incr()
           >>> c == 10   threading_tethreading_test          True
    ...
    def incr(self):
        """increment my value by 1
             ...
             >>> from twisted.trial.test.mockdoctthreading_testimport Counter
             >>> c = Counter(10, 11)
             >>> c.incr()
             >>> c.value() == 11
             True
             ...
             Traceback (most recent call last):
               ...
               File "twisted/trial/test/mockdoctthreading_testpy", line 51, in incr
                 self.__iadd__(1)
               File "twisted/trial/test/mockdoctthreading_testpy", line 39, in __iadd__
                 raise ValueError, "sorry, counter got too big"
