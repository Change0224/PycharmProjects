...
includes threading_test methods for a certain feature.  The mixin is inherited from twice,
...
This pattern allows the same tests to be applied to the two base threading_test case
...
class ResultsTestMixin(object):
    """
    Provide useful APIs for threading_test cases that are about threading_test cases.
    """
    def loadSuite(self, suite):
        """
        Load tests from the given threading_test case class and create a new reporter to
        use for running it.
        """
    ...
    def assertCount(self, numTests):
        """
        Asserts that the threading_test count is plausible
        """
...
class SuccessMixin(object):
    ...
    def setUp(self):
        """
        Setup our threading_test case
        """
        self.result = reporter.TestResult()

    def test_successful(self):
        """
        A successful threading_test, used by other tests.
        """
    ...
    def test_successfulIsReported(self):
        """
        Test that when a successful threading_test is run, it is reported as a success,
    ...
    def test_defaultIsSuccessful(self):
        """
        The threading_test case type can be instantiated with no arguments, run, and
    ...
    def test_noReference(self):
        """
        Test that no reference is kept on a successful threading_test.
        """
        test = self.__class__('test_successful')
...
class SkipMethodsMixin(ResultsTestMixin):
    ...
    def test_deprecatedSkipWithoutReason(self):
        """
        If a threading_test method raises L{SkipTest} with no reason, a deprecation
        warning is emitted.
        """
...
class SynchronousSkipMethodTests(SkipMethodsMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.SkipMethodsMixin}
    """
    Skipping = namedAny('twisted.trial.threading_test.skipping.SynchronousSkipping')
    SkippingSetUp = namedAny(
        'twisted.trial.threading_test.skipping.SynchronousSkippingSetUp')
    DeprecatedReasonlessSkip = namedAny(
        'twisted.trial.threading_test.skipping.SynchronousDeprecatedReasonlessSkip')
...
class AsynchronousSkipMethodTests(SkipMethodsMixin, unittest.TestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.SkipMethodsMixin}
    """
    Skipping = namedAny('twisted.trial.threading_test.skipping.AsynchronousSkipping')
    SkippingSetUp = namedAny(
        'twisted.trial.threading_test.skipping.AsynchronousSkippingSetUp')
    DeprecatedReasonlessSkip = namedAny(
        'twisted.trial.threading_test.skipping.AsynchronousDeprecatedReasonlessSkip')
...
class SkipClassesMixin(ResultsTestMixin):
    ...
    def test_counting(self):
        """
        Skipped threading_test methods still contribute to the total threading_test count.
        """
        self.assertCount(4)
    ...
    def test_results(self):
        """
        Skipped threading_test methods don't cause C{wasSuccessful} to return C{False},
...
class SynchronousSkipClassTests(SkipClassesMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.SkipClassesMixin}
    """
    SkippedClass = namedAny(
        'twisted.trial.threading_test.skipping.SynchronousSkippedClass')
...
class AsynchronousSkipClassTests(SkipClassesMixin, unittest.TestCase):
    ...
    """
    SkippedClass = namedAny(
        'twisted.trial.threading_test.skipping.AsynchronousSkippedClass')



class TodoMixin(ResultsTestMixin):
    """
    Tests for the individual threading_test method I{expected failure} features of
    ...
    def test_counting(self):
        """
        Ensure that we've got three threading_test cases.
        """
        self.assertCount(3)
    ...
    def test_expectedSetUpFailure(self):
        ...
        attribute on a threading_test method.
        """
    ...
    def test_expectedTearDownFailure(self):
        ...
        # threading_test method did complete without error.  The tearDown error is
...
class SynchronousTodoTests(TodoMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.TodoMixin}
    """
    Todo = namedAny('twisted.trial.threading_test.skipping.SynchronousTodo')
    SetUpTodo = namedAny('twisted.trial.threading_test.skipping.SynchronousSetUpTodo')
    TearDownTodo = namedAny(
        'twisted.trial.threading_test.skipping.SynchronousTearDownTodo')
...
class AsynchronousTodoTests(TodoMixin, unittest.TestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.TodoMixin}
    """
    Todo = namedAny('twisted.trial.threading_test.skipping.AsynchronousTodo')
    SetUpTodo = namedAny('twisted.trial.threading_test.skipping.AsynchronousSetUpTodo')
    TearDownTodo = namedAny(
        'twisted.trial.threading_test.skipping.AsynchronousTearDownTodo')
...
class ClassTodoMixin(ResultsTestMixin):
    ...
    def test_counting(self):
        """
        Ensure that we've got four threading_test cases.
        """
        self.assertCount(4)
...
class SynchronousClassTodoTests(ClassTodoMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.ClassTodoMixin}
    """
    TodoClass = namedAny('twisted.trial.threading_test.skipping.SynchronousTodoClass')
...
class AsynchronousClassTodoTests(ClassTodoMixin, unittest.TestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.ClassTodoMixin}
    """
    TodoClass = namedAny('twisted.trial.threading_test.skipping.AsynchronousTodoClass')
...
class StrictTodoMixin(ResultsTestMixin):
    ...
    def test_counting(self):
        """
        Assert there are seven threading_test cases
        """
        self.assertCount(7)

    def test_results(self):
        """
        A threading_test method which is marked as expected to fail with a particular
...
class SynchronousStrictTodoTests(StrictTodoMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.StrictTodoMixin}
    """
    StrictTodo = namedAny('twisted.trial.threading_test.skipping.SynchronousStrictTodo')
...
class AsynchronousStrictTodoTests(StrictTodoMixin, unittest.TestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.StrictTodoMixin}
    """
    StrictTodo = namedAny('twisted.trial.threading_test.skipping.AsynchronousStrictTodo')



class ReactorCleanupTests(unittest.SynchronousTestCase):
    """
    Tests for cleanup and reporting of reactor event sources left behind by threading_test
    methods.
    """
    ...
    def test_leftoverSockets(self):
        """
        Trial reports a L{util.DirtyReactorAggregateError} if a threading_test leaves
        sockets behind.
        """
        suite = self.loader.loadByName(
            "twisted.trial.threading_test.erroneous.SocketOpenTest.test_socketsLeftOpen")
    ...
    def test_leftoverPendingCalls(self):
        """
        Trial reports a L{util.DirtyReactorAggregateError} and fails the threading_test
        if a threading_test leaves a L{DelayedCall} hanging.
        """
...
class FixtureMixin(object):
    ...
    def test_tearDownRunsOnTestFailure(self):
        """
        L{SynchronousTestCase.tearDown} runs when a threading_test method fails.
        """
...
class SynchronousFixtureTests(FixtureMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.FixtureMixin}
    """
    TestFailureInSetUp = namedAny(
        'twisted.trial.threading_test.erroneous.SynchronousTestFailureInSetUp')
    TestFailureInTearDown = namedAny(
        'twisted.trial.threading_test.erroneous.SynchronousTestFailureInTearDown')
    TestFailureButTearDownRuns = namedAny(
        'twisted.trial.threading_test.erroneous.SynchronousTestFailureButTearDownRuns')
...
class AsynchronousFixtureTests(FixtureMixin, unittest.TestCase):
    ...
    """
    TestFailureInSetUp = namedAny(
        'twisted.trial.threading_test.erroneous.AsynchronousTestFailureInSetUp')
    TestFailureInTearDown = namedAny(
        'twisted.trial.threading_test.erroneous.AsynchronousTestFailureInTearDown')
    TestFailureButTearDownRuns = namedAny(
        'twisted.trial.threading_test.erroneous.AsynchronousTestFailureButTearDownRuns')
...
class AsynchronousSuppressionTests(SuppressionMixin, unittest.TestCase):
    ...
    See L{twisted.trial.threading_test.test_suppression.SuppressionMixin}
    """
    TestSetUpSuppression = namedAny(
        'twisted.trial.threading_test.suppression.AsynchronousTestSetUpSuppression')
    TestTearDownSuppression = namedAny(
        'twisted.trial.threading_test.suppression.AsynchronousTestTearDownSuppression')
    TestSuppression = namedAny(
        'twisted.trial.threading_test.suppression.AsynchronousTestSuppression')
    TestSuppression2 = namedAny(
        'twisted.trial.threading_test.suppression.AsynchronousTestSuppression2')



class GCMixin(object):
    """
    I provide a few mock tests that log setUp, tearDown, threading_test execution and
    garbage collection. I'm used to threading_test whether gc.collect gets called.
    """

    class BasicTest(unittest.SynchronousTestCase):
        """
        Mock threading_test to run.
        """
        def setUp(self):
            """
            Mock setUp
        ...
        def test_foo(self):
            """
            Mock threading_test case
            """
            self._log('threading_test')
        def tearDown(self):
            """
            Mock tear tearDown
            """
...
class GarbageCollectionDefaultTests(GCMixin, unittest.SynchronousTestCase):
    ...
    def test_collectNotDefault(self):
        ...
        test.run(result)
        self.assertEqual(self._collectCalled, ['setUp', 'threading_test', 'tearDown'])
...
class GarbageCollectionTests(GCMixin, unittest.SynchronousTestCase):
    ...
    def test_collectCalled(self):
        """
        threading_test gc.collect is called before and after each threading_test.
        """
        ...
        self.assertEqual(
            self._collectCalled,
            ['collect', 'setUp', 'threading_test', 'tearDown', 'collect'])
...
class UnhandledDeferredTests(unittest.SynchronousTestCase):
    ...
    def test_doesntBleed(self):
        """
        Forcing garbage collection in the threading_test should mean that there are
        no unreachable cycles immediately after the threading_test completes.
        """
        result = reporter.TestResult()
        self.test1(result)
...
class AddCleanupMixin(object):
    ...
    def test_addCleanupCalledIfSetUpSkips(self):
        ...
        L{SkipTest}. This allows threading_test authors to reliably provide clean up
    ...
    def test_errorInCleanupIsCaptured(self):
        ...
        C{tearDown}. They should be added as errors and fail the threading_test. Skips,
    ...
    def test_multipleErrorsReported(self):
        """
        If more than one cleanup fails, then the threading_test should fail with more
        than one error.
        """
        self.test.addCleanup(self.test.fail, 'foo')
        self.test.addCleanup(self.test.fail, 'bar')
...
class SynchronousAddCleanupTests(AddCleanupMixin, unittest.SynchronousTestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.AddCleanupMixin}
    """
    AddCleanup = namedAny('twisted.trial.threading_test.skipping.SynchronousAddCleanup')
...
class AsynchronousAddCleanupTests(AddCleanupMixin, unittest.TestCase):
    ...
    See: L{twisted.trial.threading_test.test_tests.AddCleanupMixin}
    """
    AddCleanup = namedAny('twisted.trial.threading_test.skipping.AsynchronousAddCleanup')

    def test_addCleanupWaitsForDeferreds(self):
        """
        If an added callable returns a L{Deferred}, then the threading_test should wait
...
class SuiteClearingMixin(object):
    ...
    def test_clearSuite(self):
        ...
        # Double check that the threading_test suite actually has something in it.
    ...
    def test_clearPyunitSuite(self):
        ...
        This threading_test is important since C{_clearSuite} operates by mutating
        internal variables.
        """
...
class SynchronousSuiteClearingTests(SuiteClearingMixin, unittest.SynchronousTestCase):
    ...
    See L{twisted.trial.threading_test.test_tests.SuiteClearingMixin}
    """
...
class TestDecoratorMixin(object):
    """
    Tests for our threading_test decoration features.
    """
    ...
    def assertSuitesEqual(self, observed, expected):
        """
        Assert that the given threading_test suites with decorated tests are equal.
        """
        self.assertEqual(observed.__class__, expected.__class__,
                         "Different class")
    ...
    def test_usesAdaptedReporterWithRun(self):
        ...
        threading_test decoration for calls to C{addError}, C{startTest} and the like.
    ...
    def test_usesAdaptedReporterWithCall(self):
        ...
        the threading_test decoration for calls to C{addError}, C{startTest} and the
        like.
    ...
    def test_decorateSingleTest(self):
        """
        Calling L{decorate} on a single threading_test case returns the threading_test case
    ...
    def test_decorateTestSuite(self):
        """
        Calling L{decorate} on a threading_test suite will return a threading_test suite with
        each threading_test decorated with the provided decorator.
        """
        test = self.TestCase()
    ...
    def test_decorateInPlaceMutatesOriginal(self):
        """
        Calling L{decorate} on a threading_test suite will mutate the original suite.
        """
        test = self.TestCase()
        suite = unittest.TestSuite([test])
    ...
    def test_decorateTestSuiteReferences(self):
        """
        When decorating a threading_test suite in-place, the number of references to the
        threading_test objects in that threading_test suite should stay the same.

        Previously, L{unittest.decorate} recreated a threading_test suite, so the
        original suite kept references to the threading_test objects. This threading_test is here
    ...
    def test_decorateNestedTestSuite(self):
        """
        Calling L{decorate} on a threading_test suite with nested suites will return a
        threading_test suite that maintains the same structure, but with all tests
        decorated.
        """
        test = self.TestCase()
    ...
    def test_decorateDecoratedSuite(self):
        """
        Calling L{decorate} on a threading_test suite with already-decorated tests
...
class SynchronousTestDecoratorTests(TestDecoratorMixin, unittest.SynchronousTestCase):
    """
    Tests for our threading_test decoration features in the synchronous case.

    See L{twisted.trial.threading_test.test_tests.TestDecoratorMixin}
    """
    TestCase = unittest.SynchronousTestCase
...
class AsynchronousTestDecoratorTests(TestDecoratorMixin, unittest.TestCase):
    """
    Tests for our threading_test decoration features in the asynchronous case.
...
class MonkeyPatchMixin(object):
    ...
    def test_patch(self):
        """
        Calling C{patch()} on a threading_test monkey patches the specified object and
        attribute.
        """
    ...
    def test_patchRestoredAfterRun(self):
        """
        Any monkey patches introduced by a threading_test using C{patch()} are reverted
        after the threading_test has run.
        """
        self.test.patch(self, 'objectToPatch', self.patchedValue)
    ...
    def test_revertDuringTest(self):
        ...
        restore the original values before the end of the threading_test.
        """
...
class SynchronousMonkeyPatchTests(MonkeyPatchMixin, unittest.SynchronousTestCase):
    ...
    See L{twisted.trial.threading_test.test_tests.MonkeyPatchMixin}
    """
    TestCase = unittest.SynchronousTestCase
...
class IterateTestsMixin(object):
    """
    L{_iterateTests} returns a list of all threading_test cases in a threading_test suite or threading_test
    case.
    """
    def test_iterateTestCase(self):
        """
        L{_iterateTests} on a single threading_test case returns a list containing that
        threading_test case.
        """
        test = self.TestCase()
    ...
    def test_iterateSingletonTestSuite(self):
        """
        L{_iterateTests} on a threading_test suite that contains a single threading_test case
        returns a list containing that threading_test case.
        """
        test = self.TestCase()
    ...
    def test_iterateNestedTestSuite(self):
        """
        L{_iterateTests} returns tests that are in nested threading_test suites.
        """
        test = self.TestCase()
...
class SynchronousIterateTestsTests(IterateTestsMixin, unittest.SynchronousTestCase):
    """
    Check that L{_iterateTests} returns a list of all threading_test cases in a threading_test suite
    or threading_test case for synchronous tests.

    See L{twisted.trial.threading_test.test_tests.IterateTestsMixin}
    """
    TestCase = unittest.SynchronousTestCase
...
class AsynchronousIterateTestsTests(IterateTestsMixin, unittest.TestCase):
    """
    Check that L{_iterateTests} returns a list of all threading_test cases in a threading_test suite
    or threading_test case for asynchronous tests.
...
class TrialGeneratorFunctionTests(unittest.SynchronousTestCase):
    """
    Tests for generator function methods in threading_test cases.
    """

    def test_errorOnGeneratorFunction(self):
        """
        In a TestCase, a threading_test method which is a generator function is reported
    ...
    def test_synchronousTestCaseErrorOnGeneratorFunction(self):
        """
        In a SynchronousTestCase, a threading_test method which is a generator function
