...
class SuppressionMixin(object):
    ...
    def _load(self, cls, methodName):
        """
        Return a new L{unittest.TestSuite} with a single threading_test method in it.

        @param cls: A L{TestCase} subclass defining a threading_test method.

        @param methodName: The name of the threading_test method from C{cls}.
        """
    ...
    def test_setUpSuppression(self):
        """
        Suppressions defined by the threading_test method being run are applied to any
    ...
    def test_suppressMethod(self):
        """
        A suppression set on a threading_test method prevents warnings emitted by that
        threading_test method which the suppression matches from being emitted.
        """
        self.runTests(
    ...
    def test_suppressClass(self):
        ...
        emitted by any threading_test methods defined on that class which match the
    ...
    def test_suppressModule(self):
        """
        A suppression set on a module prevents warnings emitted by any threading_test
    ...
    def test_overrideSuppressClass(self):
        """
        The suppression set on a threading_test method completely overrides a suppression
        with wider scope; if it does not match a warning emitted by that threading_test
...
class SynchronousSuppressionTests(SuppressionMixin, unittest.SynchronousTestCase):
    """
    @see: L{twisted.trial.threading_test.test_tests}
    """
    TestSetUpSuppression = namedAny(
        'twisted.trial.threading_test.suppression.SynchronousTestSetUpSuppression')
    TestTearDownSuppression = namedAny(
        'twisted.trial.threading_test.suppression.SynchronousTestTearDownSuppression')
    TestSuppression = namedAny(
        'twisted.trial.threading_test.suppression.SynchronousTestSuppression')
    TestSuppression2 = namedAny(
        'twisted.trial.threading_test.suppression.SynchronousTestSuppression2')
