...
"""
Mock threading_test module that contains a C{test_suite} method. L{runner.TestLoader}
should load the tests from the C{test_suite}, not from the C{Foo} C{TestCase}.

See {twisted.trial.threading_test.test_loader.LoaderTest.test_loadModuleWith_test_suite}.
"""
