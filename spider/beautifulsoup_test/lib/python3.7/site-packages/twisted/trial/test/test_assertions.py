...
initially assumed to work.  The threading_test classes are arranged so that the methods
...
class TestFailureTests(pyunit.TestCase):
    ...
    can be used to fail a threading_test, and that that failure is reflected in the threading_test
    ...
    class FailingTest(unittest.SynchronousTestCase):
        def test_fails(self):
            self.fail("This threading_test fails.")


    def setUp(self):
        """
        Load a suite of one threading_test which can be used to exercise the failure
        handling behavior.
        """
        components = [
    ...
    def test_failingExceptionFails(self):
        """
        When a threading_test method raises L{SynchronousTestCase.failureException}, the threading_test is
...
class AssertFalseTests(unittest.SynchronousTestCase):
    ...
    def _assertFalseFalse(self, method):
        """
        Perform the positive case threading_test for C{failIf} or C{assertFalse}.

        @param method: The threading_test method to threading_test.
        """
    ...
    def _assertFalseTrue(self, method):
        """
        Perform the negative case threading_test for C{failIf} or C{assertFalse}.
...
class AssertTrueTests(unittest.SynchronousTestCase):
    ...
    def _assertTrueFalse(self, method):
        """
        Perform the negative case threading_test for C{assertTrue} and C{failUnless}.
    ...
    def _assertTrueTrue(self, method):
        """
        Perform the positive case threading_test for C{assertTrue} and C{failUnless}.
...
class SynchronousAssertionsTests(unittest.SynchronousTestCase):
    ...
    failIf*, assert* (not covered by other more specific threading_test classes).
    ...
    def test_assertRaisesContextUnexpected(self):
        ...
        try:
            ...
            self.fail(
                "Mismatched exception type should have caused threading_test failure.")
    ...
    def test_assertRaisesContextNoException(self):
        ...
        try:
            ...
            self.fail("Non-exception result should have caused threading_test failure.")
...
if sys.version_info >= (3, 5):
    ...
    class ResultOfCoroutineAssertionsTests(unittest.SynchronousTestCase):
        """
        A dummy class to show that this threading_test file was discovered but the tests
        ...
        def test_notAvailable(self):
            """
            A skipped threading_test to show that this was not run because the Python is
            too old.
            """
...
class AssertionNamesTests(unittest.SynchronousTestCase):
    ...
    def test_failUnlessMatchesAssert(self):
        """
        The C{failUnless*} threading_test methods are a subset of the C{assert*} threading_test
...
class CallDeprecatedTests(unittest.SynchronousTestCase):
    ...
    def test_failsWithoutDeprecation(self):
        """
        L{callDeprecated} raises a threading_test failure if the callable is not
        deprecated.
        """
        def notDeprecated():
            pass
    ...
    def test_failsWithIncorrectDeprecation(self):
        """
        callDeprecated raises a threading_test failure if the callable was deprecated
    ...
    def test_callDeprecationWithWrongMessage(self):
        ...
        L{callDeprecated} raises a threading_test failure.
        """
        exception = self.assertRaises(
            self.failureException,
            self.callDeprecated,
