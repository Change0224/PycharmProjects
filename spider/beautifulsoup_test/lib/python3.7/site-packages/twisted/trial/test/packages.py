...
"""
Classes and functions used by L{twisted.trial.threading_test.test_util}
and L{twisted.trial.threading_test.test_loader}.
"""
...
class PackageTest(unittest.SynchronousTestCase):
    files = [
        ...
        ('goodpackage/spider_book.py', ''),
        ('goodpackage/test_sample.py', testSample),
        ('goodpackage/sub/spider_book.py', ''),
        ('goodpackage/sub/test_sample.py', testSample),
        ('inheritancepackage/spider_book.py', ''),
