...
class Mask(object):
    """
    Hide a threading_test case definition from trial's automatic discovery mechanism.
    """
    class MockTests(SynchronousTestCase):
        """
        A threading_test case which is used by L{FlushWarningsTests} to verify behavior
        which cannot be verified by code inside a single threading_test method.
        """
...
class FlushWarningsTests(SynchronousTestCase):
    ...
    emitted so far in a threading_test.
    """
    ...
    def test_none(self):
        """
        If no warnings are emitted by a threading_test, C{flushWarnings} returns an empty
        list.
        """
    ...
    def test_several(self):
        """
        If several warnings are emitted by a threading_test, C{flushWarnings} returns a
    ...
    def test_unflushed(self):
        """
        Any warnings emitted by a threading_test which are not flushed are emitted to the
    ...
    def test_flushed(self):
        """
        Any warnings emitted by a threading_test which are flushed are not emitted to the
        Python warning system.
        """
        result = TestResult()
    ...
    def test_missingSource(self):
        ...
        package.makedirs()
        package.child(b'spider_book.py').setContent(b'')
...
class CollectWarningsTests(SynchronousTestCase):
    ...
    def test_duplicateWarningCollected(self):
        ...
        # to ensure that even modules which are first imported as a threading_test is
    ...
    def test_setWarningRegistryChangeWhileIterating(self):
        ...
        really a module and imports things on setattr.  py.threading_test does this, as
