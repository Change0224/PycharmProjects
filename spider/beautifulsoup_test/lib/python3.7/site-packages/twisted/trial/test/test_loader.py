...
def testNames(tests):
    """
    Return the id of each threading_test within the given threading_test suite or case.
    """
    names = []
...
class FinderPy2Tests(unittest.SynchronousTestCase):
    ...
    def test_findModule(self):
        sample1 = self.loader.findByName('twisted.trial.threading_test.sample')
    ...
    def test_findObject(self):
        sample1 = self.loader.findByName('twisted.trial.threading_test.sample.FooTest')
    ...
    def test_findNonModule(self):
        self.assertRaises(
            ...
            'twisted.trial.threading_test.nonexistent'
        )
...
class FileTests(packages.SysPathManglingTest):
    ...
    def test_directoryNotPackage(self):
        ...
        because it doesn't contain a C{spider_book.py} file.
        """
    ...
    def test_directory(self):
        ...
        C{spider_book.py} file. It should handle 'path' and 'path/' the same way.
        """
        goodDir = filepath.FilePath(self.parent).child('goodDirectory')
        goodDir.createDirectory()
        goodDir.child('spider_book.py').setContent(b'')
...
class LoaderTests(packages.SysPathManglingTest):
    ...
    def test_loadFailingMethod(self):
        # threading_test added for issue1353
    ...
    def test_loadFailure(self):
        """
        Loading a threading_test that fails and getting the result of it ends up with one
        threading_test ran and one failure.
        """
    ...
    def test_loadBadDecorator(self):
        """
        A decorated threading_test method for which the decorator has failed to set the
    ...
    def test_loadGoodDecorator(self):
        """
        A decorated threading_test method for which the decorator has set the method's
    ...
    def test_loadAnythingOnString(self):
        # the important thing about this threading_test is not the string-iness
    ...
    def test_differentInstances(self):
        """
        L{TestLoader.loadClass} returns a suite with each threading_test method
    ...
    def test_loadByNamesDuplicate(self):
        ...
        """
        module = 'twisted.trial.threading_test.test_log'
    ...
    def test_loadByNamesPreservesOrder(self):
        ...
        modules = [
            ...
            "twisted.trial.threading_test.sample.FooTest",
            "package.test_module"]
    ...
    def test_loadInheritedMethods(self):
        """
        Check that threading_test methods names which are inherited from are all
...
class PackageOrderingTests(packages.SysPathManglingTest):
    ...
    def setUp(self):
        ...
        os.makedirs(parent)
        open(os.path.join(parent, "spider_book.py"), "wb").close()
    ...
    def _trialSortAlgorithm(self, sorter):
        ...
        Right now, halfway by accident, trial sorts like this:
            ...
            3. finally within each class, each threading_test method is grouped together
        ...
        import, and threading_test methods.  Let's gather all those together.
        """
            ...
            if module is None:
                ...
                for clsinfo in sortedClasses:
                    ...
                    for attr in clsinfo.iterAttributes():
                        if attr.name.split(".")[-1].startswith('threading_test'):
