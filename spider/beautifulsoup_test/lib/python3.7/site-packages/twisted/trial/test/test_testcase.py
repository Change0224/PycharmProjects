...
class TestCaseMixin(object):
    ...
    def setUp(self):
        """
        Create a couple instances of C{MyTestCase}, each for the same threading_test
        method, to be used in the threading_test methods of this class.
        """
    ...
    def test_equality(self):
        """
        In order for one threading_test method to be runnable twice, two TestCase
        instances with the same threading_test method name must not compare as equal.
        """
    ...
    def test_hashability(self):
        """
        In order for one threading_test method to be runnable twice, two TestCase
        instances with the same threading_test method name should not have the same
        hash value.
        """
        container = {}
...
class SynchronousTestCaseTests(TestCaseMixin, SynchronousTestCase):
    class MyTestCase(SynchronousTestCase):
        """
        Some threading_test methods which can be used to threading_test behaviors of
