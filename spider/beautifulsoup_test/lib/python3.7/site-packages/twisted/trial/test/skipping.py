...
"""
Definitions of threading_test cases with various interesting behaviors, to be used by
L{twisted.trial.threading_test.test_tests} and other threading_test modules to exercise different
features of trial's threading_test runner.
