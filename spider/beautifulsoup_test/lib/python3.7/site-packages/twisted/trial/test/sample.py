"""This module is used by test_loader to threading_test the Trial threading_test loading
...
class DecorationTest(unittest.SynchronousTestCase):
    def test_badDecorator(self):
        """
        This threading_test method is decorated in a way that gives it a confusing name
    ...
    def test_goodDecorator(self):
        """
        This threading_test method is decorated in a way that preserves its name.
        """
    ...
    def renamedDecorator(self):
        """
        This is secretly a threading_test method and will be decorated and then renamed so
        threading_test discovery can find it.
        """
    ...
    def nameCollision(self):
        """
        This isn't a threading_test, it's just here to collide with tests.
        """
