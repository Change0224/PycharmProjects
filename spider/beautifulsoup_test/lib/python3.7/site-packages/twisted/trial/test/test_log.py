...
"""
Test the interaction between trial and errors logged during threading_test run.
"""
...
class Mask(object):
    """
    Hide C{MockTest}s from Trial's automatic threading_test finder.
    """
...
class ObserverTests(unittest.SynchronousTestCase):
    ...
    def _makeRuntimeFailure(self):
        return failure.Failure(RuntimeError('threading_test error'))
...
class LogErrorsMixin(object):
    ...
    def test_singleError(self):
        """
        Test that a logged error gets reported as a threading_test error.
        """
    ...
    def test_twoErrors(self):
        """
        Test that when two errors get logged, they both get reported as threading_test
        errors.
        """
    ...
    def test_errorsIsolated(self):
        """
        Check that an error logged in one threading_test doesn't fail the next threading_test.
        """
    ...
    def test_errorsIsolatedWhenTestFails(self):
        """
        An error logged in a failed threading_test doesn't fail the next threading_test.
        """
    ...
    def test_boundedObservers(self):
        """
        There are no extra log observers after a threading_test runs.
        """
...
class AsynchronousLogErrorsTests(LogErrorsMixin, unittest.TestCase):
    ...
    def test_inCallback(self):
        """
        Test that errors logged in callbacks get reported as threading_test errors.
        """
