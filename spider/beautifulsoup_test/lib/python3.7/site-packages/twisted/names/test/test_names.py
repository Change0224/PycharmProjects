...
soa_record = dns.Record_SOA(
                    mname = b'threading_test-domain.com',
                    rname = u'root.threading_test-domain.com',
                    serial = 100,
                    refresh = 1234,
                    minimum = 7654,
                    expire = 19283784,
...
my_soa = dns.Record_SOA(
    ...
    rname = b'postmaster.threading_test-domain.com',
    serial = 130,
    refresh = 12345,
    minimum = 1,
    expire = 999999,
...
test_domain_com = NoFileAuthority(
    soa = (b'threading_test-domain.com', soa_record),
    records = {
        b'threading_test-domain.com': [
            soa_record,
            ...
            dns.Record_MX(10, u'host.threading_test-domain.com'),
            dns.Record_HINFO(os=b'Linux', cpu=b'A Fast One, Dontcha know'),
            dns.Record_CNAME(b'canonical.name.com'),
            dns.Record_MB(b'mailbox.threading_test-domain.com'),
            ...
            dns.Record_AFSDB(subtype=1, hostname=b'afsdb.threading_test-domain.com'),
...
#
        ...
        b'cname.threading_test-domain.com': [
            dns.Record_CNAME(b'threading_test-domain.com')
        ],
...
reverse_domain = NoFileAuthority(
    ...
    records = {
        b'123.93.84.28.in-addr.arpa': [
             dns.Record_PTR(b'threading_test.host-reverse.lookup.com'),
             reverse_soa
        ]
    }
)
...
class ServerDNSTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        while 1:
            ...
            # the threading_test (if the listenUDP below fails).  Cleaning up
    ...
    def namesTest(self, querying, expectedRecords):
        ...
        @param expectedRecords: A L{list} of L{IRecord} providers which must be
            in the response or the threading_test will be failed.
    ...
    def test_addressRecord1(self):
        ...
        return self.namesTest(
            self.resolver.lookupAddress('threading_test-domain.com'),
    ...
    def test_addressRecord2(self):
        ...
        return self.namesTest(
            self.resolver.lookupAddress('host.threading_test-domain.com'),
    ...
    def test_addressRecord3(self):
        ...
        return self.namesTest(
            self.resolver.lookupAddress('host-two.threading_test-domain.com'),
    ...
    def test_authority(self):
        ...
        return self.namesTest(
            self.resolver.lookupAuthority('threading_test-domain.com'),
            [soa_record]
        )
    ...
    def test_mailExchangeRecord(self):
        ...
        """
        return self.namesTest(
            self.resolver.lookupMailExchange(b"threading_test-domain.com"),
            [dns.Record_MX(10, b"host.threading_test-domain.com", ttl=19283784),
    ...
    def test_nameserver(self):
        ...
        return self.namesTest(
            self.resolver.lookupNameservers('threading_test-domain.com'),
    ...
    def test_HINFO(self):
        ...
        return self.namesTest(
            self.resolver.lookupHostInfo('threading_test-domain.com'),
            [dns.Record_HINFO(os=b'Linux', cpu=b'A Fast One, Dontcha know',
                              ttl=19283784)]
        )
    ...
    def test_PTR(self):
        ...
        return self.namesTest(
            ...
            [dns.Record_PTR('threading_test.host-reverse.lookup.com', ttl=11193983)]
        )
    ...
    def test_CNAME(self):
        ...
        return self.namesTest(
            self.resolver.lookupCanonicalName('threading_test-domain.com'),
    ...
    def test_MB(self):
        ...
        return self.namesTest(
            self.resolver.lookupMailBox('threading_test-domain.com'),
            [dns.Record_MB('mailbox.threading_test-domain.com', ttl=19283784)]
        )
    ...
    def test_MG(self):
        ...
        return self.namesTest(
            self.resolver.lookupMailGroup('threading_test-domain.com'),
    ...
    def test_MR(self):
        ...
        return self.namesTest(
            self.resolver.lookupMailRename('threading_test-domain.com'),
    ...
    def test_MINFO(self):
        ...
        return self.namesTest(
            self.resolver.lookupMailboxInfo('threading_test-domain.com'),
    ...
    def test_SRV(self):
        ...
        return self.namesTest(
            self.resolver.lookupService('http.tcp.threading_test-domain.com'),
    ...
    def test_AFSDB(self):
        ...
        return self.namesTest(
            self.resolver.lookupAFSDatabase('threading_test-domain.com'),
            [dns.Record_AFSDB(subtype=1, hostname='afsdb.threading_test-domain.com', ttl=19283784)]
        )
    ...
    def test_RP(self):
        ...
        return self.namesTest(
            self.resolver.lookupResponsibility('threading_test-domain.com'),
    ...
    def test_TXT(self):
        ...
        return self.namesTest(
            self.resolver.lookupText('threading_test-domain.com'),
            [dns.Record_TXT(b'A First piece of Text', b'a SecoNd piece',
                            ttl=19283784),
             dns.Record_TXT(b'Some more text, haha!  Yes.  \0  Still here?',
                            ttl=19283784)]
    ...
    def test_spf(self):
        ...
        """
        return self.namesTest(
            self.resolver.lookupSenderPolicy('threading_test-domain.com'),
            [dns.Record_SPF(b'v=spf1 mx/30 mx:example.org/30 -all',
                            ttl=19283784),
            dns.Record_SPF(b'v=spf1 +mx a:\0colo',
    ...
    def test_WKS(self):
        ...
        return self.namesTest(
            self.resolver.lookupWellKnownServices('threading_test-domain.com'),
    ...
    def test_AAAA(self):
        ...
        return self.namesTest(
            self.resolver.lookupIPV6Address('threading_test-domain.com'),
    ...
    def test_A6(self):
        ...
        return self.namesTest(
            self.resolver.lookupAddress6('threading_test-domain.com'),
    ...
    def test_zoneTransfer(self):
        ...
        for r in results:
            if r.ttl is None:
                r.ttl = default_ttl
        return self.namesTest(
            self.resolver.lookupZone('threading_test-domain.com').addCallback(lambda r: (r[0][:-1],)),
            results
        )
    ...
    def test_NAPTR(self):
        ...
        """
        return self.namesTest(
            self.resolver.lookupNamingAuthorityPointer('threading_test-domain.com'),
            [dns.Record_NAPTR(100, 10, b"u", b"sip+E2U",
                              b"!^.*$!sip:information@domain.tld!",
                              ttl=19283784)])
...
class AdditionalProcessingTests(unittest.TestCase):
    ...
    def assertRecordsMatch(self, expected, computed):
        ...
        @param computed: A L{list} of L{RRHeader} instances giving the records
            computed by the scenario under threading_test.
