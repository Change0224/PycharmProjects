...
class ConsumerProxyTests(unittest.TestCase):
    ...
    def testWrite(self):
        # NOTE: This threading_test only valid for streaming (Push) systems.
...
# TODO:
#  threading_test that web request finishing bug (when we weren't proxying
#    unregisterProducer but were proxying finish, web file transfers
#    would hang on the last block.)
#  threading_test what happens if writeSomeBytes decided to write zero bytes.
