...
class CooperatorTests(unittest.TestCase):
    ...
    def testResourceExhaustion(self):
        ...
        # testing a private method because only the threading_test case will ever care
    ...
    def testCallbackReCoiterate(self):
        ...
        of scheduling work.  (This threading_test was added to demonstrate a specific bug
...
class AliasTests(unittest.TestCase):
    """
    Integration threading_test to verify that the global singleton aliases do what
    they're supposed to.
    """
...
class RunStateTests(unittest.TestCase):
    ...
    def test_stopDeferred(self):
        ...
        # our threading_test value, 7, because this Deferred is returned to and consumed
