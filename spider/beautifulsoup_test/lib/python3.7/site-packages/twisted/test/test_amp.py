...
class SimpleSymmetricCommandProtocol(FactoryNotifier):
    ...
    def switchit(self, name):
        if name == b'threading_test-proto':
...
class ParsingTests(unittest.TestCase):
    ...
    def test_ParsingRoundTrip(self):
        ...
        SIMPLE = (b'simple', b'threading_test')
        CE = (b'ceq', b': ')
        CR = (b'crtest', b'threading_test\r')
        LF = (b'lftest', b'hello\n')
        NEWLINE = (b'newline', b'threading_test\r\none\r\ntwo')
        NEWLINE2 = (b'newline2', b'threading_test\r\none\r\n two')
...
class FakeSender:
    ...
    def expectError(self):
        """
        Expect one error, so that the threading_test doesn't fail.
        """
...
class CommandDispatchTests(unittest.TestCase):
    ...
    compatibility and to provide more granular, readable units of threading_test
    coverage.
    """
    ...
    def test_receivedAsk(self):
        ...
        input = amp.Box(_command="hello",
                        _ask="threading_test-command-id",
                        hello="world")
...
class BinaryProtocolTests(unittest.TestCase):
    ...
    def setUp(self):
        """
        Keep track of all boxes received by this threading_test in its capacity as an
...
class AMPTests(unittest.TestCase):
    ...
    def test_basicLiteralEmit(self):
        ...
        c.callRemote(Hello, hello=b'hello threading_test', mixedCase=b'mixed case arg threading_test',
                     dash_arg=b'x', underscore_arg=b'y')
        p.flush()
        self.assertEqual(len(L), 1)
        for k, v in [(b'_command', Hello.commandName),
                     (b'hello', b'hello threading_test'),
                     (b'mixedCase', b'mixed case arg threading_test'),
                     (b'dash-arg', b'x'),
    ...
    def test_basicStructuredEmit(self):
        ...
        self.assertEqual(L[0],
                          ((), dict(
                    hello=b'hello threading_test',
                    mixedCase=b'mixed case arg threading_test',
                    dash_arg=b'x',
                    underscore_arg=b'y',
...
class NormalCommandProtocol(amp.AMP):
    """
    This is a protocol which responds to L{BaseCommand}, and is used to threading_test
...
class InheritedCommandProtocol(amp.AMP):
    ...
    threading_test that inherited commands inherit their bases' errors if they do not
...
class AddedCommandProtocol(amp.AMP):
    ...
    threading_test that inherited commands can add their own new types of errors, but
...
class NoNetworkProtocol(amp.AMP):
    ...
    L{MagicSchemaCommand} that does nothing, so that tests can threading_test
...
class DescriptorTests(unittest.TestCase):
    ...
    def test_fromStringProto(self):
        ...
        This is a whitebox threading_test which involves direct L{_DescriptorExchanger}
        state inspection.
        """
...
if not interfaces.IReactorSSL.providedBy(reactor):
    skipMsg = 'This threading_test case requires SSL support in the reactor'
