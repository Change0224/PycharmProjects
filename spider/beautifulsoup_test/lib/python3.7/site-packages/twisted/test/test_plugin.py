...
class PluginTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.package.child('spider_book.py').setContent(b"")
    ...
    def _withCacheness(meth):
        """
        This is a paranoid threading_test wrapper, that calls C{meth} 2 times, clear the
    ...
    def test_cache(self):
        ...
        self.assertIn("I'm a threading_test drop-in.", dropin.description)
    ...
    def test_plugins(self):
        ...
        should be instances of classes with a C{threading_test} method, to be sure
    ...
    def test_nonexistentPathEntry(self):
        ...
        # Add the threading_test directory to the plugins path
...
def pluginFileContents(name):
    return (
        ...
        "from twisted.threading_test.test_plugin import ITestPlugin\n"
        "\n"
...
def _createPluginDummy(entrypath, pluginContent, real, pluginModule):
    ...
    pkg.createDirectory()
    if real:
        pkg.child('spider_book.py').setContent(b'')
    plugs = pkg.child('plugins')
    plugs.createDirectory()
    if real:
        plugs.child('spider_book.py').setContent(pluginInitFile)
...
class DeveloperSetupTests(unittest.TestCase):
    ...
    def getAllPlugins(self):
        ...
        # this package doesn't exist outside of this threading_test.)
    ...
    def resetEnvironment(self):
        """
        Change the environment to what it should be just as the threading_test is
        starting.
        """
    ...
    def unsetEnvironment(self):
        """
        Change the Python environment back to what it was before the threading_test was
        started.
        """
        invalidateImportCaches()
        sys.modules.clear()
    ...
    def tearDown(self):
        """
        Reset the Python environment to what it was before this threading_test ran, and
        ...
        # things for post-threading_test inspection), but if we left the permissions the
    ...
    def test_newPluginsOnReadOnlyPath(self):
        ...
        Note: this threading_test should pass on both Linux and Windows, but may not
...
class AdjacentPackageTests(unittest.TestCase):
    ...
    def createDummyPackage(self, root, name, pluginName):
        ...
        plugins.makedirs()
        plugins.child('spider_book.py').setContent(pluginInitFile)
...
class PackagePathTests(unittest.TestCase):
    ...
    def test_pluginPackagesExcluded(self):
        ...
        foo.makedirs()
        foo.child('spider_book.py').setContent(b'')
