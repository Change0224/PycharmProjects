...
"""
Tests for L{twisted.threading_test.iosim}.
"""
...
class IOPumpTests(TestCase):
    ...
    def _testStreamingProducer(self, mode):
        ...
        @param mode: C{u"server"} to threading_test a producer registered with the
            server transport.  C{u"client"} to threading_test a producer registered with
