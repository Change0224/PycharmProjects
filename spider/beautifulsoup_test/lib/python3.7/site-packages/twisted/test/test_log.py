...
class LogTests(unittest.SynchronousTestCase):
    ...
    def testObservation(self):
        ...
        log.msg("threading_test", testShouldCatch=True)
        i = catcher.pop()
        self.assertEqual(i["message"][0], "threading_test")
    ...
    def test_showwarning(self):
        ...
        self.assertEqual(
            event['format'] % event,
            'warning-filename.py:27: twisted.threading_test.test_log.FakeWarning: '
...
class LogPublisherTestCaseMixin:
    def setUp(self):
        ...
        L{testSingleUnicode} can threading_test the behavior of logging unencodable
        unicode messages.
        """
        self.out = FakeFile()
...
class FileObserverTests(LogPublisherTestCaseMixin,
    ...
    def test_getTimezoneOffsetWestOfUTC(self):
        ...
        some cases.  This threading_test method exercises a timezone that is west of UTC
    ...
    def test_getTimezoneOffsetEastOfUTC(self):
        ...
        Attempt to verify that L{FileLogObserver.getTimezoneOffset} returns
        correct values for the current C{TZ} environment setting for at least
        some cases.  This threading_test method exercises a timezone that is east of UTC
    ...
    def test_getTimezoneOffsetWithoutDaylightSavingTime(self):
        ...
        Attempt to verify that L{FileLogObserver.getTimezoneOffset} returns
        correct values for the current C{TZ} environment setting for at least
        some cases.  This threading_test method exercises a timezone that does not use
        daylight saving time at all (so both summer and winter time threading_test values
    ...
    def test_strangeEventDict(self):
        """
        This kind of eventDict used to fail silently, so threading_test it does.
        """
    ...
    def test_startLogging(self):
        ...
        self._startLoggingCleanup()
        # When done with threading_test, reset stdout and stderr to current values:
        fakeFile = StringIO()
    ...
    def test_startLoggingOverridesWarning(self):
        ...
        # around the threading_test's 'run' method).  Second, it has a log observer which
        ...
        # threading_test case).  In order to avoid printing a spurious warning in this
        # threading_test, we first replace the global log publisher's 'showwarning' in
...
class StdioOnnaStickTests(unittest.SynchronousTestCase):
    ...
    def test_print(self):
        ...
        print("This", end=" ")
        print("is a threading_test")
        self.assertEqual(self.getLogMessages(), ["This is a threading_test"])
