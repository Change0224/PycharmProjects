...
class InternetTests(unittest.TestCase):
    ...
    def testUNIX(self):
        # FIXME: This threading_test is far too dense.  It needs comments.
        #  -- spiv, 2004-11-07
        s = service.MultiService()
        s.startService()
        factory = protocol.ServerFactory()
    ...
    def test_importAll(self):
        ...
        subclasses. This threading_test ensures that the subclasses exposed by C{__all__}
    ...
    def test_reactorSelectionMixin(self):
        ...
        class ReactorSelectionOptions(usage.Options, app.ReactorSelectionMixin):
            def subCommands(self):
                ...
                return [('subcommand', None, lambda: self, 'threading_test subcommand')]
...
class BackoffPolicyTests(unittest.TestCase):
    ...
    def test_does_not_overflow_on_high_attempts(self):
        ...
        parameter. In previous versions, this threading_test failed when attempt was
        larger than 1750.
