...
class Synchronization(object):
    ...
    def run(self):
        ...
        # This is just the only way I can think of to wake up the threading_test
...
class ThreadPoolTests(unittest.SynchronousTestCase):
    ...
    def _threadpoolTest(self, method):
        ...
        """
        # This is a schizophrenic threading_test: it seems to be trying to threading_test
    ...
    def test_callInThreadWithCallback(self):
        ...
        tp = threadpool.ThreadPool(0, 1)
        tp.callInThreadWithCallback(onResult, lambda: "threading_test")
        tp.start()
        ...
        self.assertEqual(results[1], "threading_test")
...
class RaceConditionTests(unittest.SynchronousTestCase):
    ...
    def test_synchronization(self):
        ...
        @note: This is not really a unit threading_test, it is a stress-threading_test.  You may
            need to run it with C{trial -u} to fail reliably if there is a
            problem.  It is very hard to regression-threading_test for this particular
...
class MemoryPool(threadpool.ThreadPool):
    ...
    def __init__(self, coordinator, failTest, newWorker, *args, **kwargs):
        """
        Initialize this L{MemoryPool} with a threading_test case.
        ...
        @param failTest: A 1-argument callable taking an exception and raising
            a threading_test-failure exception.
...
class PoolHelper(object):
    ...
    @ivar threadpool: a modified L{threadpool.ThreadPool} to threading_test.
    ...
    def __init__(self, testCase, *args, **kwargs):
        ...
        @param testCase: a threading_test case attached to this helper.
...
class MemoryBackedTests(unittest.SynchronousTestCase):
    """
    Tests using L{PoolHelper} to deterministically threading_test properties of the
