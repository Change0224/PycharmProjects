...
class LoopTests(unittest.TestCase):
    ...
    def test_withCountFloatingPointBoundary(self):
        ...
        This is a regression threading_test for a particularly tricky case to implement.
        """
        clock = task.Clock()
        accumulator = []
        ...
        count = 10
        # 'timespan': the amount of virtual time that the threading_test will take, in
        ...
        # count, timespan, and interval are changed, that the threading_test remains
...
class ReactorLoopTests(unittest.TestCase):
    ...
    def testFailurePropagation(self):
        ...
        #
        # To make sure this threading_test does not hang trial when LoopingCall does not
