...
class StandardInputOutputTests(unittest.TestCase):
    ...
    def _spawnProcess(self, proto, sibling, *args, **kw):
        ...
        """
        args = [sys.executable,
                b"-m", b"twisted.threading_test." + sibling,
    ...
    def test_lastWriteReceived(self):
        ...
        # Note: the macOS bug which prompted the addition of this threading_test
        ...
        # because it makes the threading_test quite slow.
