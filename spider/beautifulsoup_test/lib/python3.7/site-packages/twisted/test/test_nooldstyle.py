    ...
    def test_onlyOldStyleMayBeDecorated(self):
        ...
        self.assertEqual(
            ...
            ("twisted.python._oldstyle._oldStyle is being used to decorate a "
             "new-style class (twisted.threading_test.test_nooldstyle.SomeNewStyleClass)"
...
class NewStyleOnlyTests(unittest.TestCase):
    """
    Tests for L{NewStyleOnly}, because threading_test turtles all the way down.
    """
...
def _buildTestClasses(_locals):
    """
    Build the threading_test classes that use L{NewStyleOnly}, one class per module.
    ...
    for x in getModule("twisted").walkModules():
        ...
        ignoredModules = [
            "twisted.threading_test.reflect_helper",
            "twisted.internet.threading_test.process_",
            "twisted.threading_test.process_"
        ]
