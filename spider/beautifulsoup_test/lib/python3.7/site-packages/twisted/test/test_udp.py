# -*- threading_test-case-name: twisted.threading_test.test_udp -*-
...
class BadClient(protocol.DatagramProtocol):
    ...
    Used to threading_test error handling behavior in the reactor for that method.
    """
    d = None
...
class UDPTests(unittest.TestCase):
    ...
    def test_sendPackets(self):
        ...
        def cbClientStarted(ignored):
            ...
            # but there is a non-trivial amount of threading_test code which might
    ...
    def test_connectionRefused(self):
        ...
        Note: This threading_test assumes no one is listening on port 80 UDP.
        """
        client = GoodClient()
        clientStarted = client.startedDeferred = defer.Deferred()
    ...
    def test_datagramReceivedError(self):
        ...
        # UDP tests will likely fail as well.  Ideally, this threading_test (and probably
        ...
        # whatever way the threading_test desires.  Unfortunately, this is hard because
        ...
        def makeAttempt():
            ...
            def cbPacketReceived(packet):
                ...
                maybe finish the threading_test.
                """
                timeoutCall.cancel()
                ...
                if len(succeededAttempts) == 2:
                    ...
                    # let the threading_test finish asserting things.
    ...
    def test_NoWarningOnBroadcast(self):
        ...
        p = udp.Port(0, Server())
        p.socket = fakeSocket()
        p.write(b"threading_test", ("<broadcast>", 1234))
...
class ReactorShutdownInteractionTests(unittest.TestCase):
    ...
    def testShutdownFromDatagramReceived(self):
        ...
        # This threading_test is primarily to ensure that the loop never spins
        # forever.
        ...
        def pktRece(ignored):
            ...
            # such as we are inducing.  This is very much a whitebox threading_test.
        ...
        def flushErrors(ignored):
            ...
            # doesn't hang, this threading_test is satisfied.  (There may be room for
            # another, stricter threading_test.)
