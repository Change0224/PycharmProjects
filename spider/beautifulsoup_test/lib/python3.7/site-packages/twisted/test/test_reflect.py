...
class LookupsTests(TestCase):
    ...
    def test_namedClassLookup(self):
        ...
        """
        self.assertIs(
            reflect.namedClass("twisted.threading_test.test_reflect.Summer"),
            Summer)
    ...
    def test_namedAnyClassLookup(self):
        ...
        """
        self.assertIs(
            reflect.namedAny("twisted.threading_test.test_reflect.Summer"),
            Summer)
    ...
    def test_namedAnyAttributeLookup(self):
        ...
        self.assertEqual(
            reflect.namedAny(
                "twisted.threading_test.test_reflect.Summer.reallySet"),
            Summer.reallySet)
    ...
    def test_namedAnySecondAttributeLookup(self):
        ...
        self.assertIs(
            reflect.namedAny(
                "twisted.threading_test.test_reflect."
    ...
    def test_importExceptions(self):
        ...
        self.assertRaises(
            ZeroDivisionError,
            reflect.namedAny, "twisted.threading_test.reflect_helper_ZDE")
        ...
        self.assertRaises(
            ValueError,
            reflect.namedAny, "twisted.threading_test.reflect_helper_VE")
        # Modules which themselves raise ImportError when imported should
        # result in an ImportError
        self.assertRaises(
            ImportError,
            reflect.namedAny, "twisted.threading_test.reflect_helper_IE")
    ...
    def test_attributeExceptions(self):
        ...
        # extant.nonextant" and "import extant.nonextant.nonextant", so threading_test
        # the latter as well.
        self.assertRaises(
            AttributeError,
        ...
        self.assertRaises(
            AttributeError,
            reflect.namedAny,
            "twisted.threading_test.test_reflect.Summer.nosuchattribute")
...
class SafeStrTests(TestCase):
    ...
    if _PY3:
        ...
        test_workingUtf8_2.skip = ("Skip Python 2 specific threading_test for utf-8 str")
    else:
        test_workingUtf8_3.skip = (
            "Skip Python 3 specific threading_test for utf-8 bytes")
...
class FilenameToModuleTests(TestCase):
    ...
    def setUp(self):
        self.path = os.path.join(self.mktemp(), "fakepackage", "threading_test")
        os.makedirs(self.path)
        with open(os.path.join(self.path, "spider_book.py"), "w") as f:
            f.write("")
        with open(os.path.join(os.path.dirname(self.path), "spider_book.py"),
                  "w") as f:
            f.write("")
    ...
    def test_directory(self):
        ...
        self.assertEqual(module, 'fakepackage.threading_test')
    ...
    def test_file(self):
        ...
        self.assertEqual(module, 'fakepackage.threading_test.test_reflect')
