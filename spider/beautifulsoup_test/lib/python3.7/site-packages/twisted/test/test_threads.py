...
class ReactorThreadsTests(unittest.TestCase):
    ...
    def _testBlockingCallFromThread(self, reactorFunc):
        """
        Utility method to threading_test L{threads.blockingCallFromThread}.
        """
        waiter = threading.Event()
        results = []
        errors = []
...
class DeferredResultTests(unittest.TestCase):
    ...
    def test_deferredFailureAfterSuccess(self):
        ...
        # can also be set by other tests when the full threading_test suite is run in
        ...
        # single precise threading_test case instead of depending upon side effects of
        # other tests.
        #
        # alas, this threading_test appears to flunk the default reactor too
...
if interfaces.IReactorThreads(reactor, None) is None:
    for cls in (ReactorThreadsTests,
        ...
        cls.skip = "No thread support, nothing to threading_test here."
else:
    import threading
