...
class FakeWindowsPath(filepath.FilePath):
    """
    A threading_test version of FilePath which overrides listdir to raise L{WindowsError}.
    """
...
class FilePathTests(AbstractFilePathTests):
    ...
    def test_temporarySiblingExtension(self):
        ...
        """
        testExtension = b".threading_test-extension"
    ...
    def test_moveToSizeCache(self, hook=lambda : None):
        ...
        This is a separate threading_test from C{test_moveToExistsCache} because it is
        ...
        # ERROR_ALREADY_EXISTS, but we don't need to threading_test that, just the cached
    ...
    def test_crossMountMoveTo(self):
        ...
        # Bit of a whitebox threading_test - force os.rename, which moveTo tries
        # before falling back to a slower method, to fail, forcing moveTo to
        # use the slower behavior.
        self.test_moveTo()
        # A bit of a sanity check for this whitebox threading_test - if our rename
        # was never invoked, the threading_test has probably fallen into disrepair!
    ...
    def test_createBinaryMode(self):
        ...
        (While this threading_test should pass on all platforms, it is only really
    ...
    def testOpen(self):
        ...
        # Make sure those bytes ended up there - and threading_test opening a file for
        ...
        # Put some bytes in a file so we can threading_test that appending does not
        # destroy them.
        ...
        with appender.open('r+') as f:
            ...
            f.seek(0, 1)
            # Put in some new bytes for us to threading_test for later.
            f.write(b'ghi')
    ...
    def test_getPermissions_Windows(self):
        ...
        Windows.  Windows requires a different threading_test, because user permissions
        ...
        bit.
        """
        # Change permission after threading_test so file can be deleted
