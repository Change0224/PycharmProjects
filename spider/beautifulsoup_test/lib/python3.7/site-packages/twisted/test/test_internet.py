...
class SystemEventTests(unittest.TestCase):
    ...
    def test_removeNonExistentSystemEventTrigger(self):
        ...
        """
        b = self.addTrigger('during', 'threading_test', lambda: None)
...
class TimeTests(unittest.TestCase):
    ...
    def test_seconds(self):
        ...
        1. This threading_test specifically does not assert any relation to the
           ...
           wallclock-time.
        2. This threading_test *also* does not assert anything about the type of
...
class DelayedTests(unittest.TestCase):
    ...
    def testGetDelayedCalls(self):
        ...
        # threading_test might fail on slow systems.
        self.checkTimers()
...
if not interfaces.IReactorProcess(reactor, None):
    ResolveTests.skip = (
        "cannot run threading_test: reactor doesn't support IReactorProcess")
...
class CallFromThreadTests(unittest.TestCase):
    ...
    """
    if interfaces.IReactorThreads(reactor, None) is None:
        skip = "Nothing to threading_test without thread support"
...
class ProducerTests(unittest.TestCase):
    ...
    def _reentrantStreamingProducerTest(self, methodName):
        ...
        # happened.  Prior to the bugfix for which this threading_test was written,
