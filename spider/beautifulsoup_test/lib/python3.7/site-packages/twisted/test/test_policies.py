...
class WrapperTests(unittest.TestCase):
    ...
    def test_transportInterfaces(self):
        ...
        # these attributes to be added to ProtocolWrapper, the threading_test will pass,
...
class ThrottlingTests(unittest.TestCase):
    ...
    def test_limit(self):
        """
        Full threading_test using a custom server limiting number of connections.
        """
        server = Server()
...
class LoggingFactoryTests(unittest.TestCase):
    ...
    def test_thingsGetLogged(self):
        ...
        f = TestLoggingFactory(wrappedFactory, 'threading_test')
    ...
    def test_loggingFactoryOpensLogfileAutomatically(self):
        ...
        wrappedFactory = protocol.ServerFactory()
        wrappedFactory.protocol = SimpleProtocol
        factory = policies.TrafficLoggingFactory(wrappedFactory, 'threading_test')
        ...
        # protocols.
        first_call = (('threading_test-1', 'w'), {})
        second_call = (('threading_test-2', 'w'), {})
