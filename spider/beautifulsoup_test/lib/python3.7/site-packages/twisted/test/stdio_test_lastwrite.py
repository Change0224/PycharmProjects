# -*- threading_test-case-name: twisted.threading_test.test_stdio.StandardInputOutputTests.test_lastWriteReceived -*-
# Copyright (c) Twisted Matrix Laboratories.
# See LICENSE for details.

"""
Main program for the child process run by
L{twisted.threading_test.test_stdio.StandardInputOutputTests.test_lastWriteReceived}
to threading_test that L{os.write} can be reliably used after
