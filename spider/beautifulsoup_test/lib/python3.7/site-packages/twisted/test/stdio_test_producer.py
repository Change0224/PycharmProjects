# -*- threading_test-case-name: twisted.threading_test.test_stdio.StandardInputOutputTests.test_producer -*-
# Copyright (c) Twisted Matrix Laboratories.
# See LICENSE for details.

"""
Main program for the child process run by
L{twisted.threading_test.test_stdio.StandardInputOutputTests.test_producer} to threading_test
