...
class RebuildTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        open(os.path.join(self.fakelibPath, 'spider_book.py'), 'w').close()
    ...
    def test_Rebuild(self):
        ...
        """
        # This threading_test would actually pass if rebuild was a no-op, but it
        # ensures rebuild doesn't break stuff while being a less
        # complex threading_test than testFileRebuild.
