    ...
    def test_connectionRefusedErrorNumber(self):
        ...
        def tryConnectFailure():
            def connected(proto):
                ...
                self.fail("Could not fail to connect - could not threading_test errno for that case.")
...
class FactoryTests(unittest.TestCase):
    ...
    def test_serverStartStop(self):
        ...
        """
        # Note - this threading_test doesn't need to use listenTCP.  It is exercising
        # logic implemented in Factory.doStart and Factory.doStop, so it could
        # just call that directly.  Some other threading_test can make sure that
...
class WriterProtocol(protocol.Protocol):
    def connectionMade(self):
        ...
        # directly flunk the threading_test. The threading_test will fail when maximum number of
...
class WriteDataTests(unittest.TestCase):
    ...
    def test_writeAfterShutdownWithoutReading(self):
        ...
        # IOCP reactor cannot pass this threading_test, though -- please see the skip
        ...
        if reactor.__class__.__name__ == 'IOCPReactor':
            raise unittest.SkipTest(
                ...
                "deliver some data, proceed with this threading_test).")
        ...
        # actions which are necessary to trigger the case this threading_test is for have
        # been taken.
        ...
        class UnreadingWriter(protocol.Protocol):
            ...
            def connectionMade(self):
                ...
                def write(ignored):
                    ...
                    # #1662.  When #1662 is fixed, this threading_test will likely
                    # need to be adjusted, otherwise connection lost
                    # notification will happen too soon and the threading_test will
        ...
        # By the end of the threading_test, the client should have received notification
...
class AddressTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        to threading_test factory behavior related to addresses.
        ...
        class RememberingWrapper(protocol.ClientFactory):
            ...
            # factory - doStart, doStop, etc aren't necessary for this threading_test
            # to pass.
            def buildProtocol(self, addr):
                """
...
class LargeBufferWriterProtocol(protocol.Protocol):
    ...
    # follow that with another write to threading_test behaviour under load (see issue
    # #9446)
...
class HalfCloseNoNotificationAndShutdownExceptionTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # XXX we don't threading_test server side yet since we don't do it yet
    ...
    def testNoNotification(self):
        ...
        support being notified of write closes.  In this case, threading_test that
...
class PauseProducingTests(unittest.TestCase):
    ...
    def test_pauseProducingInConnectionMade(self):
        ...
        ignored: this threading_test is here to ensure it's not ignored.
        """
        server = MyServerFactory()
