...
class LogFileTests(unittest.TestCase):
    ...
    def test_rotation(self):
        ...
        with contextlib.closing(
            ...
            # threading_test automatic rotation
            log.write("123")
            log.write("4567890")
            log.write("1" * 11)
            ...
            # threading_test manual rotation
            log.rotate()
    ...
    if runtime.platform.isWindows():
        test_reopen.skip = "Can't threading_test reopen on Windows"
...
class DailyLogFileTests(unittest.TestCase):
    ...
    if runtime.platform.isWindows():
        test_rotatePermissionDirectoryNotOk.skip = (
            ...
            "threading_test to reasonably do.")
