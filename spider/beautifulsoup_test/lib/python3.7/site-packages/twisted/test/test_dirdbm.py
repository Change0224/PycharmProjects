...
class DirDbmTests(unittest.TestCase):
    ...
    def test_rebuildInteraction(self):
        s = dirdbm.Shelf('dirdbm.rebuild.threading_test')
        s[b'key'] = b'value'
    ...
    def test_modificationTime(self):
        ...
        # of this threading_test. Thus we keep the range of acceptability to 3 seconds time.
        # -warner
        self.dbm[b"k"] = b"v"
    ...
    def test_recovery(self):
        """
        DirDBM: threading_test recovery from directory after a faked crash
        """
    ...
    def test_failSet(self):
        ...
        self.dbm[b"failkey"] = b"threading_test"
