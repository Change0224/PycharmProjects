...
class UnixSocketTests(unittest.TestCase):
    ...
    def test_dumber(self):
        ...
        def allConnected(args):
            ...
            # other threading_test.  This probably deserves its own threading_test method.
    ...
    def test_pidFile(self):
        ...
        # XXX This part would threading_test something about the checkPID parameter, but
        # it doesn't actually.  It should be rewritten to threading_test the several
    ...
    def test_reprWithClassicFactory(self):
        ...
        return self._reprTest(
            ClassicFactory(), "twisted.threading_test.test_unix.ClassicFactory")
    ...
    def test_reprWithNewStyleFactory(self):
        ...
        return self._reprTest(
            NewStyleFactory(), "twisted.threading_test.test_unix.NewStyleFactory")
...
class DatagramUnixSocketTests(unittest.TestCase):
    ...
    # threading_test connecting to bound and connected (somewhere else) address
    ...
    def test_reprWithClassicProtocol(self):
        ...
        return self._reprTest(
            ClassicProtocol(), "twisted.threading_test.test_unix.ClassicProtocol")
    ...
    def test_reprWithNewStyleProtocol(self):
        ...
        return self._reprTest(
            NewStyleProtocol(), "twisted.threading_test.test_unix.NewStyleProtocol")
