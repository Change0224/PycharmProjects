...
class StolenTCPTests(ProperlyCloseFilesMixin, unittest.TestCase):
    """
    For SSL transports, threading_test many of the same things which are tested for
    TCP transports.
    """
    ...
    def getHandleErrorCodeMatcher(self):
        ...
        It would be better if this threading_test worked in a way which did not
        require this.
        """
...
class ConnectionLostTests(unittest.TestCase, ContextGeneratingMixin):
    ...
    def testImmediateDisconnect(self):
        org = "twisted.threading_test.test_ssl"
