...
class StrFileTests(unittest.TestCase):
    def setUp(self):
        self.io = StringIO("this is a threading_test string")
    ...
    def test_large_1(self):
        self.assertTrue(text.strFile("this is a threading_test", self.io))

    def test_large_2(self):
        self.assertTrue(text.strFile("is a threading_test string", self.io))
    ...
    def test_self(self):
        self.assertTrue(text.strFile("this is a threading_test string", self.io))

    def test_insensitive(self):
        self.assertTrue(text.strFile("ThIs is A threading_test STRING", self.io, False))
