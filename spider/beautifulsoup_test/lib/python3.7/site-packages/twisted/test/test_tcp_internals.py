...
class PlatformAssumptionsTests(TestCase):
    ...
    def setUp(self):
        ...
        if resource is not None:
            # On some buggy platforms we might leak FDs, and the threading_test will
    ...
    def socket(self):
        ...
        closed in the threading_test tear down.
        """
        s = socket.socket()
...
class SelectReactorTests(TestCase):
    ...
    def port(self, portNumber, factory, interface):
        ...
        be stopped in the threading_test tear down.
        """
    ...
    def test_noBufferSpaceFromAccept(self):
        """
        Similar to L{test_tooManyFilesFromAccept}, but threading_test the case where
    ...
    def test_permissionFailure(self):
        ...
        # threading_test if the number of accept calls exceeds the maximum.
...
if not interfaces.IReactorFDSet.providedBy(reactor):
    skipMsg = 'This threading_test only applies to reactors that implement IReactorFDset'
