...
class _HTTPParserTests(object):
    """
    Base threading_test class for L{HTTPParser} which is responsible for the bulk of
...
class SlowRequest:
    ...
    controlled externally (for example, by code in a threading_test method).
    ...
    def test_abortAfterResponseHeaders(self):
        ...
        class BodyDestination(Protocol):
            ...
            def connectionLost(self, reason):
                ...
                the unit threading_test via C{testResult}.
                """
...
class RequestTests(TestCase):
    ...
    def test_sendRequestBodyErrorWithConsumerError(self):
        ...
        This is a whitebox threading_test.
        """
        logObserver = EventLoggingObserver.createWithCleanup(
            self,
            globalLogPublisher
...
class ResponseTests(TestCase):
    ...
    def test_finishedWithErrorWhenConnected(self):
        ...
        # Sanity check - this threading_test is for the connected state
    ...
    def test_finishedWithErrorWhenInitial(self):
        ...
        # Sanity check - this threading_test is for the initial state
