...
class EnvironTests(WSGITestsMixin, TestCase):
    ...
    def test_serverName(self):
        ...
        # twisted.threading_test.test_web.DummyChannel.transport.getHost().host
    ...
    def test_serverProtocolIsNativeString(self):
        ...
        for serverProtocol in b"1.1", u"1.1":
            ...
            # which will cause a crash after the bit we're trying to threading_test, so
...
class InputStreamTestMixin(WSGITestsMixin):
    ...
    be wrapped by an L{_InputStream} under threading_test.
    """
