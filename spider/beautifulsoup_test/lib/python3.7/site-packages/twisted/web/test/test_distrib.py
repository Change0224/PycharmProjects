...
class ArbitraryError(Exception):
    """
    An exception for this threading_test.
    """
...
class DistribTests(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        threading_test methods or indirectly via some distrib API.
        """
    ...
    def _requestAgentTest(self, child, **kwargs):
        ...
        @return: A L{Deferred} which fires with a tuple consisting of a
            L{twisted.threading_test.proto_helpers.AccumulatingProtocol} containing the
    ...
    def test_connectionLost(self):
        ...
        # error every time.  Just what we want to threading_test.
