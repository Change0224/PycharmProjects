...
class RangeTests(TestCase):
    ...
    def setUp(self):
        ...
        resource.  Each threading_test can set a different range header to threading_test different
        aspects of the implementation.
        """
        path = FilePath(self.mktemp())
        # This is just a jumble of random stuff.  It's supposed to be a good
        # set of data for this threading_test, particularly in order to avoid
    ...
    def parseMultipartBody(self, body, boundary):
        ...
        Note that this with fail the calling threading_test on certain syntactic
        problems.
        """
        sep = b"\r\n--" + boundary
