# -*- threading_test-case-name: twisted.web.threading_test.test_xmlrpc -*-
...
class Test(XMLRPC):
    ...
    # the doc string is part of the threading_test
    ...
    # don't add a doc string, it's part of the threading_test
    ...
    def xmlrpc_snowman(self, payload):
        """
        Used to threading_test that we can pass Unicode.
        """
        snowman = u"\u2603"
        if snowman != payload:
    ...
    def xmlrpc_withRequest(self, request, other):
        ...
        a threading_test to verify that the request object really is passed as
        an argument.
        """
        return (
...
class TestAuthHeader(Test):
    """
    This is used to get the header info so that we can threading_test
    authentication.
    """
    def __init__(self):
        Test.__init__(self)
...
class TestQueryFactoryCancel(xmlrpc._QueryFactory):
    ...
    L{twisted.internet.interfaces.IConnector} to threading_test connection lost.
    """
...
class XMLRPCTests(unittest.TestCase):
    ...
    def proxy(self, factory=None):
        """
        Return a new xmlrpc.Proxy for the threading_test site created in
