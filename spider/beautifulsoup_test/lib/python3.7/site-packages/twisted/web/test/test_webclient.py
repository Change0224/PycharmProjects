...
class WebClientTests(unittest.TestCase):
    ...
    def setUp(self):
        self.agent = None # for twisted.web.client.Agent threading_test
    ...
    def tearDown(self):
        if self.agent:
            # clean up connections for twisted.web.client.Agent threading_test.
            self.agent.closeCachedConnections()
            self.agent = None

        # If the threading_test indicated it might leave some server-side connections
    ...
    def test_downloadPageBrokenDownload(self):
        ...
        """
        # threading_test what happens when download gets disconnected in the middle
...
class URITests:
    ...
    def makeURIString(self, template):
        """
        Replace the string "HOST" in C{template} with this threading_test's host.
...
class URITestsForIPv6(URITests, unittest.TestCase):
    ...
    attempt is made to threading_test without.
    """
