...
class RequestTests(unittest.TestCase):
    ...
    def test_processingFailedNoTracebackByDefault(self):
        ...
        # Since we didn't "handle" the exception, flush it to prevent a threading_test
        # failure
...
class GettableResource(resource.Resource):
    ...
    def render_fred_render_ethel(self):
        """
        The unusual method name is designed to threading_test the culling method
