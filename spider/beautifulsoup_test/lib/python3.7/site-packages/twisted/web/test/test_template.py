...
class TagLoaderTests(FlattenTestCase):
    ...
    """
    def setUp(self):
        self.loader = TagLoader(tags.i('threading_test'))
    ...
    def test_flatten(self):
        ...
        self.assertFlattensImmediately(e, b'<i>threading_test</i>')
...
class FakeSite(object):
    """
    A minimal L{Site} object that we can use to threading_test displayTracebacks
    """
