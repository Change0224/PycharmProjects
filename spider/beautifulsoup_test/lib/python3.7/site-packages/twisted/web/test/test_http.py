...
class DummyNewHTTPHandler(DummyHTTPHandler):
    ...
    in its constructor, with no default arguments. This exists to threading_test an
...
def parametrizeTimeoutMixin(protocol, reactor):
    ...
    being used by the threading_test.
...
class ChunkingTests(unittest.TestCase, ResponseTestMixin):
    ...
    def test_chunkedResponses(self):
        ...
        req.responseHeaders.setRawHeaders(b"threading_test", [b"lemur"])
        req.write(b'Hello')
        req.write(b'World!')
...
Content-Disposition: form-data; name="uploadedfile"; filename="threading_test"
...
class RequestTests(unittest.TestCase, ResponseTestMixin):
    ...
    def _compatHeadersTest(self, oldName, newName):
        ...
        This is used to threading_test that the C{headers}/C{responseHeaders} and
        C{received_headers}/C{requestHeaders} pairs interact properly.
        """
        req = http.Request(DummyChannel(), False)
        getattr(req, newName).setRawHeaders(b"threading_test", [b"lemur"])
        self.assertEqual(getattr(req, oldName)[b"threading_test"], b"lemur")
    ...
    def test_getHeader(self):
        ...
        """
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(b"threading_test", [b"lemur"])
        self.assertEqual(req.getHeader(b"threading_test"), b"lemur")
    ...
    def test_getHeaderReceivedMultiples(self):
        ...
        """
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(b"threading_test", [b"lemur", b"panda"])
        self.assertEqual(req.getHeader(b"threading_test"), b"panda")
    ...
    def test_getHeaderNotFound(self):
        ...
        """
        req = http.Request(DummyChannel(), False)
        self.assertEqual(req.getHeader(b"threading_test"), None)
    ...
    def test_getAllHeaders(self):
        ...
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(b"threading_test", [b"lemur"])
        self.assertEqual(req.getAllHeaders(), {b"threading_test": b"lemur"})
    ...
    def test_getAllHeadersMultipleHeaders(self):
        ...
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(b"threading_test", [b"lemur", b"panda"])
        self.assertEqual(req.getAllHeaders(), {b"threading_test": b"panda"})
    ...
    def test_setHeader(self):
        ...
        """
        req = http.Request(DummyChannel(), False)
        req.setHeader(b"threading_test", b"lemur")
        self.assertEqual(req.responseHeaders.getRawHeaders(b"threading_test"), [b"lemur"])
    ...
    def test_addCookieWithAllArgumentsUnicode(self):
        ...
        expectedCookieValue = (
            ...
            b"Comment=threading_test; Secure; HttpOnly")
        ...
        self._checkCookie(expectedCookieValue,
            ...
            comment=u"threading_test", secure=True, httpOnly=True)
    ...
    def test_addCookieWithAllArgumentsBytes(self):
        ...
        self._checkCookie(
            ...
            comment=b"threading_test", secure=True, httpOnly=True)
    ...
    def test_parseCookies(self):
        ...
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(
            b"cookie", [b'threading_test="lemur"; test2="panda"'])
        req.parseCookies()
        self.assertEqual(
            req.received_cookies, {b"threading_test": b'"lemur"', b"test2": b'"panda"'})
    ...
    def test_parseCookiesMultipleHeaders(self):
        ...
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(
            b"cookie", [b'threading_test="lemur"', b'test2="panda"'])
        req.parseCookies()
        self.assertEqual(
            req.received_cookies, {b"threading_test": b'"lemur"', b"test2": b'"panda"'})
    ...
    def test_parseCookiesContinueAfterMalformedCookie(self):
        ...
        req = http.Request(DummyChannel(), False)
        req.requestHeaders.setRawHeaders(
            b"cookie", [b'12345; threading_test="lemur"; 12345; test2="panda"; 12345'])
        req.parseCookies()
        self.assertEqual(
            req.received_cookies, {b"threading_test": b'"lemur"', b"test2": b'"panda"'})
