...
def assertSanitized(testCase, components, expected):
    ...
    @param testCase: A threading_test case.
...
class BytesHeadersTests(TestCase):
    ...
    def test_setRawHeaders(self):
        ...
        h = Headers()
        h.setRawHeaders(b"threading_test", rawValue)
        self.assertTrue(h.hasHeader(b"threading_test"))
        self.assertTrue(h.hasHeader(b"Test"))
        self.assertEqual(h.getRawHeaders(b"threading_test"), rawValue)
    ...
    def test_addRawHeader(self):
        ...
        """
        h = Headers()
        h.addRawHeader(b"threading_test", b"lemur")
        self.assertEqual(h.getRawHeaders(b"threading_test"), [b"lemur"])
        h.addRawHeader(b"threading_test", b"panda")
        self.assertEqual(h.getRawHeaders(b"threading_test"), [b"lemur", b"panda"])
    ...
    def test_getRawHeadersNoDefault(self):
        ...
        """
        self.assertIsNone(Headers().getRawHeaders(b"threading_test"))
    ...
    def test_getRawHeadersDefaultValue(self):
        ...
        h = Headers()
        default = object()
        self.assertIdentical(h.getRawHeaders(b"threading_test", default), default)
    ...
    def test_getRawHeaders(self):
        ...
        """
        h = Headers()
        h.setRawHeaders(b"threading_test", [b"lemur"])
        self.assertEqual(h.getRawHeaders(b"threading_test"), [b"lemur"])
    ...
    def test_hasHeaderFalse(self):
        ...
        found.
        """
        self.assertFalse(Headers().hasHeader(b"threading_test"))
    ...
    def test_removeHeaderDoesntExist(self):
        ...
        """
        h = Headers()
        h.removeHeader(b"threading_test")
    ...
    def test_canonicalNameCaps(self):
        ...
        """
        h = Headers()
        self.assertEqual(h._canonicalNameCaps(b"threading_test"), b"Test")
        self.assertEqual(h._canonicalNameCaps(b"threading_test-stuff"), b"Test-Stuff")
    ...
    def test_getAllRawHeaders(self):
        ...
        """
        h = Headers()
        h.setRawHeaders(b"threading_test", [b"lemurs"])
    ...
    def test_copy(self):
        ...
        """
        h = Headers()
        h.setRawHeaders(b'threading_test', [b'foo'])
        i = h.copy()
        self.assertEqual(i.getRawHeaders(b'threading_test'), [b'foo'])
        h.addRawHeader(b'threading_test', b'bar')
        self.assertEqual(i.getRawHeaders(b'threading_test'), [b'foo'])
        i.addRawHeader(b'threading_test', b'baz')
        self.assertEqual(h.getRawHeaders(b'threading_test'), [b'foo', b'bar'])
...
class UnicodeHeadersTests(TestCase):
    ...
    def test_setRawHeaders(self):
        ...
        h = Headers()
        h.setRawHeaders("threading_test", rawValue)
        self.assertTrue(h.hasHeader(b"threading_test"))
        self.assertTrue(h.hasHeader(b"Test"))
        self.assertTrue(h.hasHeader("threading_test"))
        self.assertTrue(h.hasHeader("Test"))
        self.assertEqual(h.getRawHeaders("threading_test"), rawValue)
        self.assertEqual(h.getRawHeaders(b"threading_test"), rawEncodedValue)
    ...
    def test_addRawHeader(self):
        ...
        """
        h = Headers()
        h.addRawHeader(u"threading_test", u"lemur")
        self.assertEqual(h.getRawHeaders(u"threading_test"), [u"lemur"])
        h.addRawHeader(u"threading_test", u"panda")
        self.assertEqual(h.getRawHeaders(u"threading_test"), [u"lemur", u"panda"])
        self.assertEqual(h.getRawHeaders(b"threading_test"), [b"lemur", b"panda"])
    ...
    def test_getRawHeadersNoDefault(self):
        ...
        no default is specified.
        """
        self.assertIsNone(Headers().getRawHeaders(u"threading_test"))
    ...
    def test_getRawHeadersDefaultValue(self):
        ...
        h = Headers()
        default = object()
        self.assertIdentical(h.getRawHeaders(u"threading_test", default), default)
        self.assertIdentical(h.getRawHeaders(u"threading_test", None), None)
        self.assertEqual(h.getRawHeaders(u"threading_test", [None]), [None])
        self.assertEqual(
            h.getRawHeaders(u"threading_test", [u"\N{SNOWMAN}"]),
            [u"\N{SNOWMAN}"],
        )
    ...
    def test_getRawHeaders(self):
        ...
        """
        h = Headers()
        h.setRawHeaders(u"threading_test\u00E1", [u"lemur"])
        self.assertEqual(h.getRawHeaders(u"threading_test\u00E1"), [u"lemur"])
        self.assertEqual(h.getRawHeaders(u"Test\u00E1"), [u"lemur"])
        self.assertEqual(h.getRawHeaders(b"threading_test\xe1"), [b"lemur"])
    ...
    def test_hasHeaderTrue(self):
        ...
        h = Headers()
        h.setRawHeaders(u"threading_test\u00E1", [u"lemur"])
        self.assertTrue(h.hasHeader(u"threading_test\u00E1"))
        self.assertTrue(h.hasHeader(u"Test\u00E1"))
        self.assertTrue(h.hasHeader(b"threading_test\xe1"))
    ...
    def test_hasHeaderFalse(self):
        ...
        found.
        """
        self.assertFalse(Headers().hasHeader(u"threading_test\u00E1"))
    ...
    def test_removeHeaderDoesntExist(self):
        ...
        """
        h = Headers()
        h.removeHeader(u"threading_test")
        self.assertEqual(list(h.getAllRawHeaders()), [])
    ...
    def test_getAllRawHeaders(self):
        ...
        """
        h = Headers()
        h.setRawHeaders(u"threading_test\u00E1", [u"lemurs"])
    ...
    def test_copy(self):
        ...
        """
        h = Headers()
        h.setRawHeaders(u'threading_test\u00E1', [u'foo\u2603'])
        i = h.copy()

        # The copy contains the same value as the original
        self.assertEqual(i.getRawHeaders(u'threading_test\u00E1'), [u'foo\u2603'])
        self.assertEqual(i.getRawHeaders(b'threading_test\xe1'), [b'foo\xe2\x98\x83'])

        # Add a header to the original
        h.addRawHeader(u'threading_test\u00E1', u'bar')
        ...
        i.addRawHeader(u'threading_test\u00E1', b'baz')

        # Verify that the orignal does not have it
        self.assertEqual(
            h.getRawHeaders(u'threading_test\u00E1'), [u'foo\u2603', u'bar'])
        self.assertEqual(
            h.getRawHeaders(b'threading_test\xe1'), [b'foo\xe2\x98\x83', b'bar'])
