...
class FakeReactorAndConnectMixin:
    """
    A threading_test mixin providing a testable C{Reactor} class and a dummy C{connect}
    ...
    class StubEndpoint(object):
        ...
        resulting protocol instances are attached to the given threading_test case.
        """
...
class IntegrationTestingMixin(object):
    ...
    def integrationTest(self, hostName, expectedAddress, addressType,
        ...
        @param scheme: The scheme to threading_test, C{http} or C{https}
        @type scheme: L{bytes}
        """
...
class HTTPConnectionPoolRetryTests(TestCase, FakeReactorAndConnectMixin):
    ...
    def test_onlyRetryWithoutBody(self):
        ...
        this threading_test should be removed and PUT added to list of methods that
        support retries.
        """
        pool = client.HTTPConnectionPool(None)
        connection = client._RetryingHTTP11ClientProtocol(None, pool)
...
class Decoder1(proxyForInterface(IResponse)):
    """
    A threading_test decoder to be used by L{client.ContentDecoderAgent} tests.
    """
...
class _RedirectAgentTestsMixin(object):
    ...
    def _testRedirectDefault(self, code):
        ...
        # If possible (i.e.: SSL support is present), run the threading_test with a
