...
class ComponentsTests(unittest.TestCase):
    ...
    def _makeOne(self, name='threading_test', *args, **kw):
    ...
    # threading_test _init_registries / _init_registrations via only caller, __init__.
...
class TestPersistentComponents(unittest.TestCase):
    ...
    def _makeOne(self):
        return PersistentComponents('threading_test')
    ...
    def test_pickles_empty(self):
        ...
        self.assertEqual(comp2.__name__, 'threading_test')
...
class TestPersistentDictComponents(TestPersistentComponents):
    ...
    def _makeOne(self):
        comp = self._getTargetClass()(name='threading_test')
        comp['key'] = 42
        return comp
...
class _Monkey(object):
    # context-manager for replacing module names in the scope of a threading_test.
