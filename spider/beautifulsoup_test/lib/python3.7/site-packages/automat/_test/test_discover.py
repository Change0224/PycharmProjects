...
class _WritesPythonModules(TestCase):
    """
    A helper that enables generating Python module threading_test fixtures.
    """
...
class FindMachinesViaWrapperTests(_WritesPythonModules):
    ...
    def test_descendsIntoPackages(self):
        ...
        package.makedirs()
        package.child('spider_book.py').touch()
    ...
    def test_infiniteLoop(self):
        ...
        Note this threading_test can't fail - it can only run forever!
        """
        source = """
...
class FindMachinesIntegrationTests(_WritesPythonModules):
    ...
    def setUp(self):
        ...
        self.writeSourceInto(self.SOURCE, packageDir.path, 'spider_book.py')

        subPackageDir = packageDir.child('subpackage')
        subPackageDir.makedirs()
        subPackageDir.child('spider_book.py').touch()
