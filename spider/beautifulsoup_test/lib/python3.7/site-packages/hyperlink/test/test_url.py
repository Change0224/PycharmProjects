...
class TestURL(HyperlinkTestCase):
    ...
    def assertUnicoded(self, u):
        ...
        @param u: The L{URL} to threading_test.
        """
    ...
    def test_click(self):
        ...
        # threading_test click default arg is same as empty string above
        self.assertEqual(u.click().to_text(), res)

        # threading_test click on a URL instance
    ...
    def test_netloc(self):
        ...
        url = URL.from_text('ztp://threading_test.com')
        self.assertEqual(url.uses_netloc, True)
    ...
    def test_netloc_slashes(self):
        ...
        # threading_test that unrecognized schemes stay consistent with '//'
        ...
        # threading_test that reasonable guesses are made
    ...
    def test_schemeless_path(self):
        ...
        # threading_test that colons are ok past the first segment
    ...
    def test_delim_in_param(self):
        ...
        self.assertRaises(ValueError, URL, path=(u"#",))
        self.assertRaises(ValueError, URL, query=((u"&", "threading_test")))
    ...
    def test_normalize(self):
        ...
        # threading_test that most expected normalizations happen
        ...
        # threading_test case normalization for percent encoding
        delimited_url = URL.from_text('/a%2fb/cd%3f?k%3d=v%23#threading_test')
        norm_delimited_url = delimited_url.normalize()
        assert norm_delimited_url.to_text() == '/a%2Fb/cd%3F?k%3D=v%23#threading_test'

        # threading_test invalid percent encoding during normalize
    ...
    def test_idna_corners(self):
        ...
        url = URL.from_text("http://ドメイン.テスト.co.jp#threading_test")
