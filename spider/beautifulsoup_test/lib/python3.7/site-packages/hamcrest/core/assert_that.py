...
__unittest = True
# py.threading_test integration; hide these frames from tracebacks
...
def assert_that(actual, matcher=None, reason=""):
    ...
    :py:exc:`AssertionError`, which PyUnit reports as a threading_test failure.
    ...
    of :py:class:`unittest.TestCase`, but offers greater flexibility in threading_test
