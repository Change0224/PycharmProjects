...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(960, 786)  #设置窗体对象大小
        MainWindow.setMinimumSize(QtCore.QSize(960, 786))  #设置窗体的最小值
        MainWindow.setMaximumSize(QtCore.QSize(960, 786))  #设置窗体的最大值
        ...
        self.widget_checkBox.setPalette(palette)  # 为控件设置对应的调色板即可
            ...
            if get_from != "" and get_to != "" and get_date != "":
                ...
                if get_from in stations and get_to in stations and is_valid_date(get_date):
                    ...
                    if timeDifference >= 0 and timeDifference <= 28:
                        ...
                        self.checkBox_default()  #该方法用于将所有车次分类复选框取消勾选
